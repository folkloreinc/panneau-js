    ...
    _createClass(ColorField, [{
        ...
        value: function render() {
            ...
            var _props2 = this.props,
                ...
                other = _objectWithoutProperties(_props2, ['pickerType', 'name', 'value', 'label', 'colors', 'disabled', 'presetColors', 'colorPosition', 'withInput']);
            ...
            var buttonGroupClassName = classNames({
                'btn-group': !withInput,
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    withInput ? React.createElement(
                        'div',
                        { className: 'input-group' },
                        React.createElement(Text, _extends({}, other, {
                            inputOnly: true,
                            value: value,
