...
export const WithoutCardWithoutSort = {
    render: () => <Container itemFields={itemFields} withoutCard withoutSort />,
};
...
export const WithItemRender = {
    render: () => <Container renderItem={(it, index) => <div>Item #{index + 1}</div>} />,
};
            ...
            types={[
                {
                    ...
                    name: 'Text',
                    fields: [
                        { component: 'text', type: 'editor', name: 'text-plain', label: 'Texte' },
                    ],
                },
                {
                    id: 'html',
