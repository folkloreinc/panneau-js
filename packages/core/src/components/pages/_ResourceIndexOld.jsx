...
class ResourceIndexOld extends Component {
...
ResourceIndexOld.propTypes = propTypes;
ResourceIndexOld.defaultProps = defaultProps;

const WithResourceApi = withResourceApi()(ResourceIndexOld);
