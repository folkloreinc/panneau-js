...
interface UseMediaApiOptions {
    ...
    onProgressStep?: ((step: number) => void) | null;
    onDurationChanged?: ((duration: number) => void) | null;
    onVolumeChanged?: ((muted: boolean, volume: number) => void) | null;
    onPlay?: ((opts: { initial: boolean }) => void) | null;
    onPause?: ((opts: { midway: boolean }) => void) | null;
    onEnded?: (() => void) | null;
    onSeeked?: ((time: number) => void) | null;
    onLoadStart?: (() => void) | null;
    onCanPlayThough?: (() => void) | null;
}
...
function useMediaApi({
    ...
    const progressStepsReached = useRef<Record<number, boolean>>({});
