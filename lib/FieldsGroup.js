...
var propTypes = {
    ...
    value: _propTypes2.default.oneOfType([_propTypes2.default.object]),
    errors: _propTypes2.default.oneOfType([_propTypes2.default.object]),
    fields: _propTypes2.default.arrayOf(_propTypes2.default.shape({
        type: _propTypes2.default.string.isRequired,
        name: _propTypes2.default.string.isRequired
    })),
    getFieldComponent: _propTypes2.default.func,
    fieldsCollection: _propTypes2.default.instanceOf(_FieldsCollection2.default),
    fieldsComponents: _propTypes2.default.shape({}),
    renderNotFound: _propTypes2.default.func,
    columns: _propTypes2.default.number,
    collapsible: _propTypes2.default.bool,
    collapsibleTypes: _propTypes2.default.arrayOf(_propTypes2.default.string),
...
var FieldsGroup = function (_Component) {
    (0, _inherits3.default)(FieldsGroup, _Component);

    function FieldsGroup(props) {
        (0, _classCallCheck3.default)(this, FieldsGroup);

        var _this = (0, _possibleConstructorReturn3.default)(this, (FieldsGroup.__proto__ || Object.getPrototypeOf(FieldsGroup)).call(this, props));

        _this.renderField = _this.renderField.bind(_this);
        return _this;
    }

    (0, _createClass3.default)(FieldsGroup, [{
        key: 'onChange',
        value: function onChange(key, value) {
            ...
            if (hasKey) {
                (0, _set2.default)(newValue, key, value);
            }
        ...
        value: function getFieldComponent(key) {
            ...
            var normalizedKey = _FieldsCollection2.default.normalizeKey(key);
            ...
            if (getFieldComponent !== null) {
                ...
                var fieldKey = Object.keys(fieldsComponents).find(function (k) {
                    return _FieldsCollection2.default.normalizeKey(k) === normalizedKey;
                });
        ...
        value: function renderField(it, index) {
            ...
            var type = it.type,
                ...
                props = (0, _objectWithoutProperties3.default)(it, ['type', 'name', 'hidden', 'defaultValue']);
            ...
            var fieldValue = value && name ? (0, _get2.default)(value, name, fieldDefaultValue) : value;
            var fieldErrors = errors && name ? (0, _get2.default)(errors, name, undefined) : errors;
            ...
            return _react2.default.createElement(FieldComponent, (0, _extends3.default)({}, props, {
        ...
        value: function render() {
            ...
            return label !== null ? _react2.default.createElement(
                _FormGroup2.default,
