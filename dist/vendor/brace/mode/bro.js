flklrJsonp([ 166 ], {
    24: function(e, t) {
        ace.define("ace/mode/bro_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, o) {
            "use strict";
            var r = e("../lib/oop"), n = e("./text_highlight_rules").TextHighlightRules, i = function() {
                this.$rules = {
                    start: [ {
            ...
            }, r.inherits(i, n), t.BroHighlightRules = i;
            ...
            "use strict";
            var r = e("../../lib/oop"), n = e("../../range").Range, i = e("./fold_mode").FoldMode, s = t.FoldMode = function(e) {
            ...
            r.inherits(s, i), function() {
                ...
                this.getFoldWidget = function(e, t, o) {
                    ...
                    if (i) {
                        ...
                        var a = e.getCommentFoldRange(o, s + i[0].length, 1);
                        return a && !a.isMultiLine() && (r ? a = this.getSectionRange(e, o) : "all" != t && (a = null)), 
                        a;
                    }
                    if ("markbegin" !== t) {
                        ...
                        if (i) {
                            ...
                            return i[1] ? this.closingBracketBlock(e, i[1], o, s) : e.getCommentFoldRange(o, s, -1);
                        }
                    }
                }, this.getSectionRange = function(e, t) {
                    var o = e.getLine(t), r = o.search(/\S/), i = t, s = o.length;
                    t += 1;
                    for (var a = t, l = e.getLength(); ++t < l; ) {
                        ...
                        if (-1 !== g) {
                            ...
                            if (d) {
                                ...
                                if (d.isMultiLine()) t = d.end.row; else if (r == g) break;
                            }
                            a = t;
                        }
                    }
                    return new n(i, s, a, e.getLine(a).length);
                }, this.getCommentRegionBlock = function(e, t, o) {
                    for (var r = t.search(/\s*$/), i = e.getLength(), s = o, a = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, l = 1; ++o < i; ) {
                        t = e.getLine(o);
                        var g = a.exec(t);
                        if (g && (g[1] ? l-- : l++, !l)) break;
                    }
                    var d = o;
                    if (d > s) return new n(s, r, d, t.length);
                };
            }.call(s.prototype);
        }), ace.define("ace/mode/bro", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/bro_highlight_rules", "ace/mode/folding/cstyle" ], function(e, t, o) {
            "use strict";
            var r = e("../lib/oop"), n = e("./text").Mode, i = e("./bro_highlight_rules").BroHighlightRules, s = e("./folding/cstyle").FoldMode, a = function() {
