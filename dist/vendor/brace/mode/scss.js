        ...
        ace.define("ace/mode/scss_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules" ], function(e, t, r) {
            ...
            var o = e("../lib/oop"), i = e("../lib/lang"), n = e("./text_highlight_rules").TextHighlightRules, a = function() {
                ...
                this.$rules = {
                    start: [ {
                        ...
                        token: function(i) {
                            return e.hasOwnProperty(i.toLowerCase()) ? "support.type" : n.hasOwnProperty(i) ? "keyword" : r.hasOwnProperty(i) ? "constant.language" : t.hasOwnProperty(i) ? "support.function" : o.hasOwnProperty(i.toLowerCase()) ? "support.constant.color" : a.hasOwnProperty(i.toLowerCase()) ? "variable.language" : "text";
                        },
                        regex: "\\-?[@a-z_][@a-z0-9_\\-]*"
                    }, {
                        token: "variable",
            ...
            (function() {
                this.checkOutdent = function(e, t) {
                    ...
                    e.replace(new o(t, 0, t, n - 1), s);
                }, this.$getIndent = function(e) {
                    return e.match(/^\s*/)[0];
                };
            }).call(i.prototype), t.MatchingBraceOutdent = i;
        }), ace.define("ace/mode/behaviour/css", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/behaviour", "ace/mode/behaviour/cstyle", "ace/token_iterator" ], function(e, t, r) {
            "use strict";
            var o = e("../../lib/oop"), i = (e("../behaviour").Behaviour, e("./cstyle").CstyleBehaviour), n = e("../../token_iterator").TokenIterator, a = function() {
                this.inherit(i), this.add("colon", "insertion", function(e, t, r, o, i) {
                    if (":" === i) {
                        var a = r.getCursorPosition(), s = new n(o, a.row, a.column), l = s.getCurrentToken();
                ...
                }), this.add("colon", "deletion", function(e, t, r, o, i) {
                    var a = o.doc.getTextRange(i);
                    if (!i.isMultiLine() && ":" === a) {
                        var s = r.getCursorPosition(), l = new n(o, s.row, s.column), c = l.getCurrentToken();
                        if (c && c.value.match(/\s+/) && (c = l.stepBackward()), c && "support.type" === c.type) {
                            if (";" === o.doc.getLine(i.start.row).substring(i.end.column, i.end.column + 1)) return i.end.column++, 
                            i;
                        }
                    }
                }), this.add("semicolon", "insertion", function(e, t, r, o, i) {
                    if (";" === i) {
                        var n = r.getCursorPosition();
                        if (";" === o.doc.getLine(n.row).substring(n.column, n.column + 1)) return {
                            text: "",
                            selection: [ 1, 1 ]
                        };
                    }
            ...
            o.inherits(a, i), t.CssBehaviour = a;
        }), ace.define("ace/mode/folding/cstyle", [ "require", "exports", "module", "ace/lib/oop", "ace/range", "ace/mode/folding/fold_mode" ], function(e, t, r) {
            "use strict";
            var o = e("../../lib/oop"), i = e("../../range").Range, n = e("./fold_mode").FoldMode, a = t.FoldMode = function(e) {
            ...
            o.inherits(a, n), function() {
                ...
                this.getFoldWidget = function(e, t, r) {
                    ...
                    var i = e.getLine(r);
                    if (this.startRegionRe.test(i)) return this.getCommentRegionBlock(e, i, r);
                    ...
                    if (n) {
                        ...
                        return s && !s.isMultiLine() && (o ? s = this.getSectionRange(e, r) : "all" != t && (s = null)), 
                        s;
                    }
                    if ("markbegin" !== t) {
                        ...
                        if (n) {
                            ...
                            return n[1] ? this.closingBracketBlock(e, n[1], r, a) : e.getCommentFoldRange(r, a, -1);
                        }
                    }
                }, this.getSectionRange = function(e, t) {
                    var r = e.getLine(t), o = r.search(/\S/), n = t, a = r.length;
                    t += 1;
                    for (var s = t, l = e.getLength(); ++t < l; ) {
                        ...
                        if (-1 !== c) {
                            ...
                            if (d) {
                                ...
                                if (d.isMultiLine()) t = d.end.row; else if (o == c) break;
                            }
                            s = t;
                        }
                    }
                    ...
                    for (var o = t.search(/\s*$/), n = e.getLength(), a = r, s = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, l = 1; ++r < n; ) {
                        t = e.getLine(r);
                        var c = s.exec(t);
                        if (c && (c[1] ? l-- : l++, !l)) break;
                    }
                    var d = r;
                    if (d > a) return new i(a, o, d, t.length);
                };
            }.call(a.prototype);
        }), ace.define("ace/mode/scss", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/scss_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/css", "ace/mode/folding/cstyle" ], function(e, t, r) {
            "use strict";
            var o = e("../lib/oop"), i = e("./text").Mode, n = e("./scss_highlight_rules").ScssHighlightRules, a = e("./matching_brace_outdent").MatchingBraceOutdent, s = e("./behaviour/css").CssBehaviour, l = e("./folding/cstyle").FoldMode, c = function() {
                this.HighlightRules = n, this.$outdent = new a(), this.$behaviour = new s(), this.foldingRules = new l();
            };
            o.inherits(c, i), function() {
                this.lineCommentStart = "//", this.blockComment = {
                    start: "/*",
                    end: "*/"
                }, this.getNextLineIndent = function(e, t, r) {
                    var o = this.$getIndent(t), i = this.getTokenizer().getLineTokens(t, e).tokens;
                    return i.length && "comment" == i[i.length - 1].type ? o : (t.match(/^.*\{\s*$/) && (o += r), 
                    o);
