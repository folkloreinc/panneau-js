flklrJsonp([ 140 ], {
    59: function(e, t) {
        ace.define("ace/mode/haskell_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            "use strict";
            var o = e("../lib/oop"), a = e("./text_highlight_rules").TextHighlightRules, r = function() {
                this.$rules = {
                    start: [ {
            ...
            }, o.inherits(r, a), t.HaskellHighlightRules = r;
        }), ace.define("ace/mode/folding/cstyle", [ "require", "exports", "module", "ace/lib/oop", "ace/range", "ace/mode/folding/fold_mode" ], function(e, t, n) {
            "use strict";
            var o = e("../../lib/oop"), a = e("../../range").Range, r = e("./fold_mode").FoldMode, l = t.FoldMode = function(e) {
            ...
            o.inherits(l, r), function() {
                ...
                this.getFoldWidget = function(e, t, n) {
                    ...
                    var r = a.match(this.foldingStartMarker);
                    if (r) {
                        var l = r.index;
                        if (r[1]) return this.openingBracketBlock(e, r[1], n, l);
                        var i = e.getCommentFoldRange(n, l + r[0].length, 1);
                        return i && !i.isMultiLine() && (o ? i = this.getSectionRange(e, n) : "all" != t && (i = null)), 
                        i;
                    }
                    if ("markbegin" !== t) {
                        var r = a.match(this.foldingStopMarker);
                        if (r) {
                            var l = r.index + r[0].length;
                            return r[1] ? this.closingBracketBlock(e, r[1], n, l) : e.getCommentFoldRange(n, l, -1);
                        }
                    }
                }, this.getSectionRange = function(e, t) {
                    var n = e.getLine(t), o = n.search(/\S/), r = t, l = n.length;
                    t += 1;
                    for (var i = t, s = e.getLength(); ++t < s; ) {
                        n = e.getLine(t);
                        var h = n.search(/\S/);
                        if (-1 !== h) {
                            if (o > h) break;
                            ...
                            if (c) {
                                ...
                                if (c.isMultiLine()) t = c.end.row; else if (o == h) break;
                            }
                            i = t;
                        }
                    }
                    return new a(r, l, i, e.getLine(i).length);
                }, this.getCommentRegionBlock = function(e, t, n) {
                    for (var o = t.search(/\s*$/), r = e.getLength(), l = n, i = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, s = 1; ++n < r; ) {
                        t = e.getLine(n);
                        var h = i.exec(t);
                        if (h && (h[1] ? s-- : s++, !s)) break;
                    }
                    var c = n;
                    if (c > l) return new a(l, o, c, t.length);
                };
            }.call(l.prototype);
            ...
            "use strict";
            var o = e("../lib/oop"), a = e("./text").Mode, r = e("./haskell_highlight_rules").HaskellHighlightRules, l = e("./folding/cstyle").FoldMode, i = function() {
