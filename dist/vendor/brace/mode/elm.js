    ...
    45: function(e, t) {
        ace.define("ace/mode/elm_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            var o = e("../lib/oop"), r = e("./text_highlight_rules").TextHighlightRules, i = function() {
                ...
                }, "identifier"), t = /\\(\d+|['"\\&trnbvf])/, n = /[a-z_]/.source, o = /[A-Z]/.source, r = /[a-z_A-Z0-9']/.source;
                this.$rules = {
                    start: [ {
                        token: "string.start",
                        regex: '"',
                        ...
                        onMatch: function(e, t, n) {
                            return this.next = 2 == e.length ? "blockComment" : "docComment", this.token;
                        }
                    }, {
            ...
            "use strict";
            var o = e("../../lib/oop"), r = e("../../range").Range, i = e("./fold_mode").FoldMode, a = t.FoldMode = function(e) {
            ...
            o.inherits(a, i), function() {
                ...
                this.getFoldWidget = function(e, t, n) {
                    ...
                    var n = e.getLine(t), o = n.search(/\S/), i = t, a = n.length;
                    t += 1;
                    ...
                    for (var o = t.search(/\s*$/), i = e.getLength(), a = n, s = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, g = 1; ++n < i; ) {
                        t = e.getLine(n);
                        var l = s.exec(t);
                        if (l && (l[1] ? g-- : g++, !g)) break;
                    }
                    var c = n;
                    if (c > a) return new r(a, o, c, t.length);
                };
            }.call(a.prototype);
            ...
            "use strict";
            var o = e("../lib/oop"), r = e("./text").Mode, i = e("./elm_highlight_rules").ElmHighlightRules, a = e("./folding/cstyle").FoldMode, s = function() {
