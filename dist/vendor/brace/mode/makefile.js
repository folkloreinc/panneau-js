flklrJsonp([ 117 ], {
    90: function(e, t) {
        ace.define("ace/mode/sh_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            "use strict";
            var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, o = e("./sh_highlight_rules"), a = function() {
                var e = this.createKeywordMapper({
            ...
            r.inherits(a, i), function() {
                this.getFoldWidgetRange = function(e, t, n) {
                    ...
                    if (-1 != s && "#" == a[s]) {
                        for (var l = a.length, d = e.getLength(), g = n, u = n; ++n < d; ) {
                            a = e.getLine(n);
                            var c = a.search(i);
                            if (-1 != c) {
                                if ("#" != a[c]) break;
                    ...
                    var r = e.getLine(n), i = r.search(/\S/), o = e.getLine(n + 1), a = e.getLine(n - 1), s = a.search(/\S/), l = o.search(/\S/);
                    if (-1 == i) return e.foldWidgets[n - 1] = -1 != s && s < l ? "start" : "", "";
                    if (-1 == s) {
                        if (i == l && "#" == r[i] && "#" == o[i]) return e.foldWidgets[n - 1] = "", e.foldWidgets[n + 1] = "", 
                        "start";
            ...
            "use strict";
            var r = e("../lib/oop"), i = e("./text").Mode, o = e("./makefile_highlight_rules").MakefileHighlightRules, a = e("./folding/coffee").FoldMode, s = function() {
