        ...
        ace.define("ace/mode/doc_comment_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            (function() {
                this.checkOutdent = function(e, t) {
                    ...
                    if (!r) return 0;
                    var o = r[1].length, a = e.findMatchingBracket({
                        row: t,
                        column: o
                    });
            ...
            i.inherits(a, o), function() {
                ...
                this.getFoldWidget = function(e, t, n) {
                    ...
                    var n = e.getLine(t), i = n.search(/\S/), o = t, a = n.length;
                    t += 1;
                    ...
                    for (var i = t.search(/\s*$/), o = e.getLength(), a = n, s = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, g = 1; ++n < o; ) {
                        t = e.getLine(n);
                        var c = s.exec(t);
                        if (c && (c[1] ? g-- : g++, !g)) break;
                    }
                    var l = n;
                    if (l > a) return new r(a, i, l, t.length);
                };
            }.call(a.prototype);
        }), ace.define("ace/mode/folding/csharp", [ "require", "exports", "module", "ace/lib/oop", "ace/range", "ace/mode/folding/cstyle" ], function(e, t, n) {
            "use strict";
            var i = e("../../lib/oop"), r = e("../../range").Range, o = e("./cstyle").FoldMode, a = t.FoldMode = function(e) {
                e && (this.foldingStartMarker = new RegExp(this.foldingStartMarker.source.replace(/\|[^|]*?$/, "|" + e.start)), 
                this.foldingStopMarker = new RegExp(this.foldingStopMarker.source.replace(/\|[^|]*?$/, "|" + e.end)));
            };
            i.inherits(a, o), function() {
                this.usingRe = /^\s*using \S/, this.getFoldWidgetRangeBase = this.getFoldWidgetRange, 
                this.getFoldWidgetBase = this.getFoldWidget, this.getFoldWidget = function(e, t, n) {
                    ...
                    if (!i) {
                        ...
                        var o = this.usingRe;
                        if (o.test(r)) {
                            var a = e.getLine(n - 1), s = e.getLine(n + 1);
                    ...
                    if (i) return i;
                    var r = e.getLine(n);
                    return this.usingRe.test(r) ? this.getUsingStatementBlock(e, r, n) : /^\s*#region\b/.test(r) ? this.getRegionBlock(e, r, n) : void 0;
                }, this.getUsingStatementBlock = function(e, t, n) {
                    for (var i = t.match(this.usingRe)[0].length - 1, o = e.getLength(), a = n, s = n; ++n < o; ) if (t = e.getLine(n), 
                    !/^\s*$/.test(t)) {
            ...
            "use strict";
            var i = e("../lib/oop"), r = e("./text").Mode, o = e("./csharp_highlight_rules").CSharpHighlightRules, a = e("./matching_brace_outdent").MatchingBraceOutdent, s = e("./behaviour/cstyle").CstyleBehaviour, g = e("./folding/csharp").FoldMode, c = function() {
                this.HighlightRules = o, this.$outdent = new a(), this.$behaviour = new s(), this.foldingRules = new g();
            };
            i.inherits(c, r), function() {
                this.lineCommentStart = "//", this.blockComment = {
                    ...
                    var i = this.$getIndent(t), r = this.getTokenizer().getLineTokens(t, e), o = r.tokens;
