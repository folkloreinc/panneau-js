        ...
        ace.define("ace/mode/fortran_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            r.inherits(a, o), function() {
                ...
                this.getFoldWidget = function(e, t, n) {
                    ...
                    for (var r = t.search(/\s*$/), o = e.getLength(), a = n, s = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, g = 1; ++n < o; ) {
                        t = e.getLine(n);
                        var l = s.exec(t);
            ...
            "use strict";
            var r = e("../lib/oop"), i = e("./text").Mode, o = e("./fortran_highlight_rules").FortranHighlightRules, a = e("./folding/cstyle").FoldMode, s = e("../range").Range, g = function() {
