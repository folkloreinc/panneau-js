        ...
        ace.define("ace/mode/perl_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            r.inherits(s, o), function() {
                ...
                this.getFoldWidget = function(e, t, n) {
                    ...
                    for (var a = t, g = e.getLength(); ++t < g; ) {
                        ...
                        if (-1 !== c) {
                            ...
                            if (l) {
                                ...
                                if (l.isMultiLine()) t = l.end.row; else if (r == c) break;
                            }
                            a = t;
                        }
                    }
                    ...
                    for (var r = t.search(/\s*$/), o = e.getLength(), s = n, a = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, g = 1; ++n < o; ) {
                        t = e.getLine(n);
                        var c = a.exec(t);
                        if (c && (c[1] ? g-- : g++, !g)) break;
                    }
                    var l = n;
                    if (l > s) return new i(s, r, l, t.length);
                };
            }.call(s.prototype);
            ...
            "use strict";
            var r = e("../lib/oop"), i = e("./text").Mode, o = e("./perl_highlight_rules").PerlHighlightRules, s = e("./matching_brace_outdent").MatchingBraceOutdent, a = e("./folding/cstyle").FoldMode, g = function() {
                this.HighlightRules = o, this.$outdent = new s(), this.foldingRules = new a({
                    start: "^=(begin|item)\\b",
                    end: "^=(cut)\\b"
