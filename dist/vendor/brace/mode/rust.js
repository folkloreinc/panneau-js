flklrJsonp([ 89 ], {
    122: function(e, t) {
        ace.define("ace/mode/rust_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, r) {
            "use strict";
            var o = e("../lib/oop"), n = e("./text_highlight_rules").TextHighlightRules, s = /\\(?:[nrt0'"\\]|x[\da-fA-F]{2}|u\{[\da-fA-F]{6}\})/.source, i = function() {
                this.$rules = {
                    start: [ {
                        ...
                        onMatch: function(e, t, r) {
                            return r.unshift(this.next, e.length - 1, t), "string.quoted.raw.source.rust";
                        },
                        regex: /r#*"/,
                        next: [ {
                            onMatch: function(e, t, r) {
                                var o = "string.quoted.raw.source.rust";
                                return e.length >= r[1] ? (e.length > r[1] && (o = "invalid"), r.shift(), r.shift(), 
                                this.next = r.shift()) : this.next = "", o;
                            },
                            regex: /"#*/,
                            next: "start"
                        }, {
            ...
            }, o.inherits(i, n), t.RustHighlightRules = i;
            ...
            "use strict";
            var o = e("../../lib/oop"), n = e("../../range").Range, s = e("./fold_mode").FoldMode, i = t.FoldMode = function(e) {
            ...
            o.inherits(i, s), function() {
                ...
                this.getFoldWidget = function(e, t, r) {
                    ...
                    var n = e.getLine(r);
                    if (this.startRegionRe.test(n)) return this.getCommentRegionBlock(e, n, r);
                    var s = n.match(this.foldingStartMarker);
                    if (s) {
                        var i = s.index;
                        if (s[1]) return this.openingBracketBlock(e, s[1], r, i);
                        var a = e.getCommentFoldRange(r, i + s[0].length, 1);
                        return a && !a.isMultiLine() && (o ? a = this.getSectionRange(e, r) : "all" != t && (a = null)), 
                        a;
                    }
                    if ("markbegin" !== t) {
                        ...
                        if (s) {
                            ...
                            return s[1] ? this.closingBracketBlock(e, s[1], r, i) : e.getCommentFoldRange(r, i, -1);
                        }
                    }
                }, this.getSectionRange = function(e, t) {
                    var r = e.getLine(t), o = r.search(/\S/), s = t, i = r.length;
                    t += 1;
                    for (var a = t, u = e.getLength(); ++t < u; ) {
                        r = e.getLine(t);
                        var c = r.search(/\S/);
                        if (-1 !== c) {
                            if (o > c) break;
                            ...
                            if (l) {
                                ...
                                if (l.isMultiLine()) t = l.end.row; else if (o == c) break;
                            }
                            a = t;
                        }
                    }
                    return new n(s, i, a, e.getLine(a).length);
                }, this.getCommentRegionBlock = function(e, t, r) {
                    for (var o = t.search(/\s*$/), s = e.getLength(), i = r, a = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, u = 1; ++r < s; ) {
                        t = e.getLine(r);
                        var c = a.exec(t);
                        if (c && (c[1] ? u-- : u++, !u)) break;
                    }
                    var l = r;
                    if (l > i) return new n(i, o, l, t.length);
                };
            }.call(i.prototype);
        }), ace.define("ace/mode/rust", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/rust_highlight_rules", "ace/mode/folding/cstyle" ], function(e, t, r) {
            "use strict";
            var o = e("../lib/oop"), n = e("./text").Mode, s = e("./rust_highlight_rules").RustHighlightRules, i = e("./folding/cstyle").FoldMode, a = function() {
                this.HighlightRules = s, this.foldingRules = new i(), this.$behaviour = this.$defaultBehaviour;
            };
