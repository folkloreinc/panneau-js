flklrJsonp([ 97 ], {
    112: function(e, t) {
        ace.define("ace/mode/prolog_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, o) {
            "use strict";
            ...
            }, n.inherits(i, r), t.PrologHighlightRules = i;
            ...
            "use strict";
            var n = e("../../lib/oop"), r = e("../../range").Range, i = e("./fold_mode").FoldMode, a = t.FoldMode = function(e) {
            ...
            n.inherits(a, i), function() {
                ...
                this.getFoldWidget = function(e, t, o) {
                    ...
                    var r = e.getLine(o);
                    if (this.startRegionRe.test(r)) return this.getCommentRegionBlock(e, r, o);
                    ...
                    if ("markbegin" !== t) {
                        ...
                        if (i) {
                            ...
                            return i[1] ? this.closingBracketBlock(e, i[1], o, a) : e.getCommentFoldRange(o, a, -1);
                        }
                    }
                }, this.getSectionRange = function(e, t) {
                    var o = e.getLine(t), n = o.search(/\S/), i = t, a = o.length;
                    t += 1;
                    for (var l = t, g = e.getLength(); ++t < g; ) {
                        o = e.getLine(t);
                        var s = o.search(/\S/);
                        if (-1 !== s) {
                            if (n > s) break;
                            ...
                            if (c) {
                                ...
                                if (c.isMultiLine()) t = c.end.row; else if (n == s) break;
                            }
                            l = t;
                        }
                    }
                    ...
                    for (var n = t.search(/\s*$/), i = e.getLength(), a = o, l = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, g = 1; ++o < i; ) {
                        t = e.getLine(o);
                        var s = l.exec(t);
                        if (s && (s[1] ? g-- : g++, !g)) break;
                    }
                    var c = o;
                    if (c > a) return new r(a, n, c, t.length);
                };
            }.call(a.prototype);
        }), ace.define("ace/mode/prolog", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/prolog_highlight_rules", "ace/mode/folding/cstyle" ], function(e, t, o) {
            "use strict";
            var n = e("../lib/oop"), r = e("./text").Mode, i = e("./prolog_highlight_rules").PrologHighlightRules, a = e("./folding/cstyle").FoldMode, l = function() {
                this.HighlightRules = i, this.foldingRules = new a(), this.$behaviour = this.$defaultBehaviour;
            };
            n.inherits(l, r), function() {
