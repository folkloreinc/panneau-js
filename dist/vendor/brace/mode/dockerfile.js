        ...
        ace.define("ace/mode/sh_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            r.inherits(a, o), function() {
                ...
                this.getFoldWidget = function(e, t, n) {
                    ...
                    var h = n;
                    if (h > a) return new i(a, r, h, t.length);
                };
            }.call(a.prototype);
            ...
            "use strict";
            var r = e("../lib/oop"), i = e("./text").Mode, o = e("./sh_highlight_rules").ShHighlightRules, a = e("../range").Range, s = e("./folding/cstyle").FoldMode, l = e("./behaviour/cstyle").CstyleBehaviour, g = function() {
            ...
            "use strict";
            var r = e("../lib/oop"), i = e("./sh_highlight_rules").ShHighlightRules, o = function() {
                i.call(this);
            ...
            r.inherits(o, i), t.DockerfileHighlightRules = o;
            ...
            "use strict";
            var r = e("../lib/oop"), i = e("./sh").Mode, o = e("./dockerfile_highlight_rules").DockerfileHighlightRules, a = e("./folding/cstyle").FoldMode, s = function() {
                i.call(this), this.HighlightRules = o, this.foldingRules = new a();
            };
