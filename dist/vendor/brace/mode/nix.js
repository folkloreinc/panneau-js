flklrJsonp([ 107 ], {
    101: function(e, t) {
        ace.define("ace/mode/doc_comment_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
                ...
                this.$rules = {
                    start: [ {
                        ...
                        token: function(e, t, n) {
                            return n[1] && "q" == n[1].charAt(0) ? "constant.language.escape" : "text";
                        },
                        next: "pop"
                    } ],
                    comment: [ {
            ...
            "use strict";
            var r = e("../lib/oop"), o = e("./c_cpp").Mode, i = e("./nix_highlight_rules").NixHighlightRules, a = e("./folding/cstyle").FoldMode, l = function() {
                o.call(this), this.HighlightRules = i, this.foldingRules = new a(), this.$behaviour = this.$defaultBehaviour;
            };
