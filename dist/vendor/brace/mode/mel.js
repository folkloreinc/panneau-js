flklrJsonp([ 112 ], {
    96: function(e, t) {
        ace.define("ace/mode/mel_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, r) {
            "use strict";
            var o = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, a = function() {
                this.$rules = {
                    start: [ {
                        caseInsensitive: !0,
            ...
            "use strict";
            var o = e("../../lib/oop"), i = e("../../range").Range, a = e("./fold_mode").FoldMode, n = t.FoldMode = function(e) {
            ...
            o.inherits(n, a), function() {
                ...
                this.getFoldWidget = function(e, t, r) {
                    ...
                    var a = i.match(this.foldingStartMarker);
                    if (a) {
                        var n = a.index;
                        if (a[1]) return this.openingBracketBlock(e, a[1], r, n);
                        var l = e.getCommentFoldRange(r, n + a[0].length, 1);
                        return l && !l.isMultiLine() && (o ? l = this.getSectionRange(e, r) : "all" != t && (l = null)), 
                        l;
                    }
                    if ("markbegin" !== t) {
                        var a = i.match(this.foldingStopMarker);
                        if (a) {
                            var n = a.index + a[0].length;
                            return a[1] ? this.closingBracketBlock(e, a[1], r, n) : e.getCommentFoldRange(r, n, -1);
                        }
                    }
                }, this.getSectionRange = function(e, t) {
                    var r = e.getLine(t), o = r.search(/\S/), a = t, n = r.length;
                    t += 1;
                    for (var l = t, s = e.getLength(); ++t < s; ) {
                        ...
                        if (-1 !== d) {
                            ...
                            if (u) {
                                ...
                                if (u.isMultiLine()) t = u.end.row; else if (o == d) break;
                            }
                            l = t;
                        }
                    }
                    ...
                    for (var o = t.search(/\s*$/), a = e.getLength(), n = r, l = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, s = 1; ++r < a; ) {
                        t = e.getLine(r);
                        var d = l.exec(t);
                        if (d && (d[1] ? s-- : s++, !s)) break;
                    }
                    var u = r;
                    if (u > n) return new i(n, o, u, t.length);
                };
            }.call(n.prototype);
        }), ace.define("ace/mode/mel", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/mel_highlight_rules", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle" ], function(e, t, r) {
            "use strict";
            var o = e("../lib/oop"), i = e("./text").Mode, a = e("./mel_highlight_rules").MELHighlightRules, n = e("./behaviour/cstyle").CstyleBehaviour, l = e("./folding/cstyle").FoldMode, s = function() {
                this.HighlightRules = a, this.$behaviour = new n(), this.foldingRules = new l();
            };
