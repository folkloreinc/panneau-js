flklrJsonp([ 152 ], {
    44: function(e, i) {
        ace.define("ace/mode/elixir_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, i, t) {
            "use strict";
            ...
            }, n.inherits(r, o), i.ElixirHighlightRules = r;
        }), ace.define("ace/mode/folding/coffee", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode", "ace/range" ], function(e, i, t) {
            "use strict";
            var n = e("../../lib/oop"), o = e("./fold_mode").FoldMode, r = e("../../range").Range, a = i.FoldMode = function() {};
            n.inherits(a, o), function() {
                this.getFoldWidgetRange = function(e, i, t) {
                    var n = this.indentationBlock(e, t);
                    if (n) return n;
                    var o = /\S/, a = e.getLine(t), l = a.search(o);
                    if (-1 != l && "#" == a[l]) {
                        for (var d = a.length, c = e.getLength(), u = t, s = t; ++t < c; ) {
                            a = e.getLine(t);
                            var x = a.search(o);
                            if (-1 != x) {
                                if ("#" != a[x]) break;
                    ...
                    var n = e.getLine(t), o = n.search(/\S/), r = e.getLine(t + 1), a = e.getLine(t - 1), l = a.search(/\S/), d = r.search(/\S/);
                    if (-1 == o) return e.foldWidgets[t - 1] = -1 != l && l < d ? "start" : "", "";
                    if (-1 == l) {
                        if (o == d && "#" == n[o] && "#" == r[o]) return e.foldWidgets[t - 1] = "", e.foldWidgets[t + 1] = "", 
                        "start";
                    } else if (l == o && "#" == n[o] && "#" == a[o] && -1 == e.getLine(t - 2).search(/\S/)) return e.foldWidgets[t - 1] = "start", 
                    e.foldWidgets[t + 1] = "", "";
                    return e.foldWidgets[t - 1] = -1 != l && l < o ? "start" : "", o < d ? "start" : "";
                };
            }.call(a.prototype);
        }), ace.define("ace/mode/elixir", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/elixir_highlight_rules", "ace/mode/folding/coffee" ], function(e, i, t) {
            "use strict";
            var n = e("../lib/oop"), o = e("./text").Mode, r = e("./elixir_highlight_rules").ElixirHighlightRules, a = e("./folding/coffee").FoldMode, l = function() {
