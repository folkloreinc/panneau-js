flklrJsonp([ 167 ], {
    23: function(e, t) {
        ace.define("ace/mode/batchfile_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, i) {
            "use strict";
            var o = e("../lib/oop"), n = e("./text_highlight_rules").TextHighlightRules, r = function() {
                this.$rules = {
                    start: [ {
            ...
            r.metaData = {
                ...
                fileTypes: [ "bat" ]
            }, o.inherits(r, n), t.BatchFileHighlightRules = r;
            ...
            "use strict";
            var o = e("../../lib/oop"), n = e("../../range").Range, r = e("./fold_mode").FoldMode, s = t.FoldMode = function(e) {
            ...
            o.inherits(s, r), function() {
                ...
                this.getFoldWidget = function(e, t, i) {
                    ...
                    if (r) {
                        ...
                        return a && !a.isMultiLine() && (o ? a = this.getSectionRange(e, i) : "all" != t && (a = null)), 
                        a;
                    }
                    if ("markbegin" !== t) {
                    ...
                    var i = e.getLine(t), o = i.search(/\S/), r = t, s = i.length;
                    t += 1;
                    ...
                    for (var o = t.search(/\s*$/), r = e.getLength(), s = i, a = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, l = 1; ++i < r; ) {
                        t = e.getLine(i);
                        var c = a.exec(t);
                        if (c && (c[1] ? l-- : l++, !l)) break;
                    }
                    var d = i;
                    if (d > s) return new n(s, o, d, t.length);
                };
            }.call(s.prototype);
        }), ace.define("ace/mode/batchfile", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/batchfile_highlight_rules", "ace/mode/folding/cstyle" ], function(e, t, i) {
            "use strict";
            var o = e("../lib/oop"), n = e("./text").Mode, r = e("./batchfile_highlight_rules").BatchFileHighlightRules, s = e("./folding/cstyle").FoldMode, a = function() {
