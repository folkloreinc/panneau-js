flklrJsonp([ 126 ], {
    79: function(e, t) {
        ace.define("ace/mode/doc_comment_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            i.inherits(a, r), t.leanHighlightRules = a;
            ...
            "use strict";
            var i = e("../lib/oop"), o = e("./text").Mode, r = e("./lean_highlight_rules").leanHighlightRules, a = e("./matching_brace_outdent").MatchingBraceOutdent, s = (e("../range").Range, 
            function() {
                this.HighlightRules = r, this.$outdent = new a();
            });
            i.inherits(s, o), function() {
                this.lineCommentStart = "--", this.blockComment = {
                    ...
                    var i = this.$getIndent(t), o = this.getTokenizer().getLineTokens(t, e), r = o.tokens, a = o.state;
