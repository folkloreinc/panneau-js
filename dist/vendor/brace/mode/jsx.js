flklrJsonp([ 130 ], {
    75: function(e, t) {
        ace.define("ace/mode/doc_comment_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            var i = e("../lib/oop"), o = e("../lib/lang"), r = e("./doc_comment_highlight_rules").DocCommentHighlightRules, a = e("./text_highlight_rules").TextHighlightRules, s = function() {
                ...
                this.$rules = {
                    start: [ {
                        ...
                        token: function(i) {
                            return "this" == i ? "variable.language" : "function" == i ? "storage.type" : e.hasOwnProperty(i) || n.hasOwnProperty(i) ? "keyword" : t.hasOwnProperty(i) ? "constant.language" : /^_?[A-Z][a-zA-Z0-9_]*$/.test(i) ? "language.support.class" : "identifier";
                        },
            ...
            var i = e("../lib/oop"), o = e("./text").Mode, r = e("./jsx_highlight_rules").JsxHighlightRules, a = e("./matching_brace_outdent").MatchingBraceOutdent, s = e("./behaviour/cstyle").CstyleBehaviour, g = e("./folding/cstyle").FoldMode;
            i.inherits(Mode, o), function() {
            ...
            }.call(Mode.prototype), t.Mode = Mode;
        });
    }
});
