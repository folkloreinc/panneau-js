flklrJsonp([ 175 ], {
    15: function(e, t) {
        ace.define("ace/mode/abc_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            }, o.inherits(r, i), t.ABCHighlightRules = r;
        }), ace.define("ace/mode/folding/cstyle", [ "require", "exports", "module", "ace/lib/oop", "ace/range", "ace/mode/folding/fold_mode" ], function(e, t, n) {
            "use strict";
            var o = e("../../lib/oop"), i = e("../../range").Range, r = e("./fold_mode").FoldMode, a = t.FoldMode = function(e) {
            ...
            o.inherits(a, r), function() {
                ...
                this.getFoldWidget = function(e, t, n) {
                    ...
                    if (r) {
                        ...
                        return g && !g.isMultiLine() && (o ? g = this.getSectionRange(e, n) : "all" != t && (g = null)), 
                        g;
                    }
                    if ("markbegin" !== t) {
                    ...
                    var n = e.getLine(t), o = n.search(/\S/), r = t, a = n.length;
                    t += 1;
                    for (var g = t, s = e.getLength(); ++t < s; ) {
                        ...
                        if (-1 !== l) {
                            ...
                            if (c) {
                                ...
                                if (c.isMultiLine()) t = c.end.row; else if (o == l) break;
                            }
                            g = t;
                        }
                    }
                    ...
                    for (var o = t.search(/\s*$/), r = e.getLength(), a = n, g = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, s = 1; ++n < r; ) {
                        t = e.getLine(n);
                        var l = g.exec(t);
                        if (l && (l[1] ? s-- : s++, !s)) break;
                    }
                    var c = n;
                    if (c > a) return new i(a, o, c, t.length);
                };
            }.call(a.prototype);
            ...
            "use strict";
            var o = e("../lib/oop"), i = e("./text").Mode, r = e("./abc_highlight_rules").ABCHighlightRules, a = e("./folding/cstyle").FoldMode, g = function() {
                this.HighlightRules = r, this.foldingRules = new a(), this.$behaviour = this.$defaultBehaviour;
            };
            o.inherits(g, i), function() {
