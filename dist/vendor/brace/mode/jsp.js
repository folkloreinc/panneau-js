flklrJsonp([ 131 ], {
    74: function(e, t) {
        ace.define("ace/mode/css_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            "use strict";
            var r = e("../lib/oop"), o = e("./doc_comment_highlight_rules").DocCommentHighlightRules, a = e("./text_highlight_rules").TextHighlightRules, i = function() {
                var e = this.createKeywordMapper({
            ...
            "use strict";
            var r = e("../lib/oop"), o = e("./html_highlight_rules").HtmlHighlightRules, a = e("./java_highlight_rules").JavaHighlightRules, i = function() {
                o.call(this);
                var e = [ {
                    token: "comment",
                    regex: "<%--",
                    ...
                    regex: "request|response|out|session|application|config|pageContext|page|Exception"
                }, {
                    token: "keyword",
                    regex: "page|include|taglib"
                } ];
                for (var n in this.$rules) this.$rules[n].unshift.apply(this.$rules[n], e);
                this.embedRules(a, "jsp-", t, [ "start" ]), this.addRules({
                    "jsp-dcomment": [ {
                        token: "comment",
                        regex: ".*?--%>",
                        next: "pop"
            ...
            "use strict";
            var r = e("../../lib/oop"), o = e("../../range").Range, a = e("./fold_mode").FoldMode, i = t.FoldMode = function(e) {
                ...
                this.getFoldWidget = function(e, t, n) {
                    ...
                    if ("markbegin" !== t) {
                        ...
                        if (a) {
                            ...
                            return a[1] ? this.closingBracketBlock(e, a[1], n, i) : e.getCommentFoldRange(n, i, -1);
                        }
                    }
                }, this.getSectionRange = function(e, t) {
                    var n = e.getLine(t), r = n.search(/\S/), a = t, i = n.length;
                    t += 1;
                    ...
                    for (var r = t.search(/\s*$/), a = e.getLength(), i = n, s = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, l = 1; ++n < a; ) {
                        t = e.getLine(n);
                        var c = s.exec(t);
                        if (c && (c[1] ? l-- : l++, !l)) break;
                    }
                    var g = n;
                    if (g > i) return new o(i, r, g, t.length);
                };
            }.call(i.prototype);
            ...
            "use strict";
            var r = e("../lib/oop"), o = e("./text").Mode, a = e("./jsp_highlight_rules").JspHighlightRules, i = e("./matching_brace_outdent").MatchingBraceOutdent, s = e("./behaviour/cstyle").CstyleBehaviour, l = e("./folding/cstyle").FoldMode, c = function() {
                this.HighlightRules = a, this.$outdent = new i(), this.$behaviour = new s(), this.foldingRules = new l();
            };
