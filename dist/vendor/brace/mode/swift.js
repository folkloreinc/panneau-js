flklrJsonp([ 78 ], {
    138: function(e, t) {
        ace.define("ace/mode/doc_comment_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            "use strict";
            var i = e("../lib/oop"), o = e("../lib/lang"), r = e("./doc_comment_highlight_rules").DocCommentHighlightRules, a = e("./text_highlight_rules").TextHighlightRules, s = function() {
                ...
                this.$rules = {
                    start: [ function(e, t) {
                        var n = t.nestable || t.interpolation, i = t.interpolation && t.interpolation.nextState || "start", r = {
                            regex: e + (t.multiline ? "" : "(?=.)"),
                            token: "string.start"
                        }, a = [ t.escape && {
                            regex: t.escape,
                            ...
                            regex: o.escapeRegExp(t.interpolation.lead + t.interpolation.open),
                            push: i
                        }, t.error && {
                            regex: t.error,
                            token: "error.invalid"
                        ...
                        var s = t.interpolation.open, l = t.interpolation.close;
                        return [ {
                            regex: "[" + o.escapeRegExp(s + l) + "]",
                            onMatch: function(e, t, n) {
                                return this.next = e == s ? this.nextState : "", e == s && n.length ? (n.unshift("start", t), 
                                "paren") : e == l && n.length && (n.shift(), this.next = n.shift(), -1 != this.next.indexOf("string")) ? "paren.quasi.end" : e == s ? "paren.lparen" : "paren.rparen";
                            },
                            nextState: i
                        }, r ];
                    }('"', {
            ...
            i.inherits(a, r), function() {
                ...
                this.getFoldWidget = function(e, t, n) {
                    ...
                    for (var i = t.search(/\s*$/), r = e.getLength(), a = n, s = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, l = 1; ++n < r; ) {
                        t = e.getLine(n);
                        var g = s.exec(t);
                        if (g && (g[1] ? l-- : l++, !l)) break;
                    }
                    var c = n;
                    if (c > a) return new o(a, i, c, t.length);
                };
            }.call(a.prototype);
            ...
            "use strict";
            var i = e("../lib/oop"), o = e("./text").Mode, r = e("./swift_highlight_rules").HighlightRules, a = e("./behaviour/cstyle").CstyleBehaviour, s = e("./folding/cstyle").FoldMode, l = function() {
                this.HighlightRules = r, this.foldingRules = new s(), this.$behaviour = new a(), 
                this.$behaviour = this.$defaultBehaviour;
            };
            i.inherits(l, o), function() {
