flklrJsonp([ 153 ], {
    42: function(e, t) {
        ace.define("ace/mode/eiffel_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, r) {
            "use strict";
            var n = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, o = function() {
                ...
                this.$rules = {
                    start: [ {
                        ...
                        token: function(t) {
                            var r = e(t);
                            return "identifier" === r && t === t.toUpperCase() && (r = "entity.name.type"), 
                            r;
                        },
            ...
            n.inherits(o, i), t.EiffelHighlightRules = o;
        }), ace.define("ace/mode/eiffel", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/eiffel_highlight_rules" ], function(e, t, r) {
            "use strict";
            var n = e("../lib/oop"), i = e("./text").Mode, o = e("./eiffel_highlight_rules").EiffelHighlightRules, a = function() {
