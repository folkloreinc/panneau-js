flklrJsonp([ 70 ], {
    149: function(e, t) {
        ace.define("ace/mode/vbscript_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            "use strict";
            var a = e("../lib/oop"), r = e("./text_highlight_rules").TextHighlightRules, o = function() {
            ...
            a.inherits(o, r), t.VBScriptHighlightRules = o;
            ...
            "use strict";
            var a = e("../lib/oop"), r = e("./text").Mode, o = e("./vbscript_highlight_rules").VBScriptHighlightRules, i = function() {
                this.HighlightRules = o, this.$behaviour = this.$defaultBehaviour;
            };
            a.inherits(i, r), function() {
