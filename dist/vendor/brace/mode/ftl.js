flklrJsonp([ 147 ], {
    49: function(e, t) {
        ace.define("ace/mode/css_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            "use strict";
            var r = e("../lib/oop"), o = e("./html_highlight_rules").HtmlHighlightRules, a = e("./text_highlight_rules").TextHighlightRules, i = function() {
                this.$rules = {
                    start: [ {
                        ...
                        regex: "encoding|parse|locale|number_format|date_format|time_format|datetime_format|time_zone|url_escaping_charset|classic_compatible|strip_whitespace|strip_text|strict_syntax|ns_prefixes|attributes"
                    }, {
                        token: "string",
                        regex: /['"]/,
                        next: "qstring"
            ...
            var s = function() {
                ...
                this.embedRules(i, "ftl-", t, [ "start" ]), this.addRules({
                    "ftl-dcomment": [ {
                        token: "comment",
                        regex: ".*?--\x3e",
                        next: "pop"
            ...
            "use strict";
            var r = e("../lib/oop"), o = e("./text").Mode, a = e("./ftl_highlight_rules").FtlHighlightRules, i = function() {
