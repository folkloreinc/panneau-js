flklrJsonp([ 113 ], {
    95: function(e, t) {
        ace.define("ace/mode/maze_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, o) {
            "use strict";
            ...
            }, n.inherits(i, r), t.MazeHighlightRules = i;
            ...
            n.inherits(a, i), function() {
                ...
                this.getFoldWidget = function(e, t, o) {
                    ...
                    for (var l = t, s = e.getLength(); ++t < s; ) {
                        ...
                        if (-1 !== g) {
                            ...
                            if (c) {
                                ...
                                if (c.isMultiLine()) t = c.end.row; else if (n == g) break;
                            }
                            l = t;
                        }
                    }
                    ...
                    for (var n = t.search(/\s*$/), i = e.getLength(), a = o, l = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, s = 1; ++o < i; ) {
                        t = e.getLine(o);
                        var g = l.exec(t);
        ...
        }), ace.define("ace/mode/maze", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/maze_highlight_rules", "ace/mode/folding/cstyle" ], function(e, t, o) {
            "use strict";
            var n = e("../lib/oop"), r = e("./text").Mode, i = e("./maze_highlight_rules").MazeHighlightRules, a = e("./folding/cstyle").FoldMode, l = function() {
