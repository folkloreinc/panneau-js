flklrJsonp([ 176 ], {
    14: function(E, e) {
        ace.define("ace/mode/abap_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(E, e, N) {
            "use strict";
            var t = E("../lib/oop"), T = E("./text_highlight_rules").TextHighlightRules, I = function() {
            ...
            t.inherits(I, T), e.AbapHighlightRules = I;
        }), ace.define("ace/mode/folding/coffee", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode", "ace/range" ], function(E, e, N) {
            "use strict";
            var t = E("../../lib/oop"), T = E("./fold_mode").FoldMode, I = E("../../range").Range, O = e.FoldMode = function() {};
            t.inherits(O, T), function() {
                this.getFoldWidgetRange = function(E, e, N) {
                    var t = this.indentationBlock(E, N);
                    if (t) return t;
                    var T = /\S/, O = E.getLine(N), n = O.search(T);
                    if (-1 != n && "#" == O[n]) {
                        for (var R = O.length, S = E.getLength(), r = N, o = N; ++N < S; ) {
                            O = E.getLine(N);
                            var i = O.search(T);
                            if (-1 != i) {
                                if ("#" != O[i]) break;
                        ...
                        if (o > r) {
                            ...
                            return new I(r, R, o, A);
                        }
                    }
                }, this.getFoldWidget = function(E, e, N) {
                    var t = E.getLine(N), T = t.search(/\S/), I = E.getLine(N + 1), O = E.getLine(N - 1), n = O.search(/\S/), R = I.search(/\S/);
                    if (-1 == T) return E.foldWidgets[N - 1] = -1 != n && n < R ? "start" : "", "";
                    if (-1 == n) {
                        if (T == R && "#" == t[T] && "#" == I[T]) return E.foldWidgets[N - 1] = "", E.foldWidgets[N + 1] = "", 
                        "start";
                    } else if (n == T && "#" == t[T] && "#" == O[T] && -1 == E.getLine(N - 2).search(/\S/)) return E.foldWidgets[N - 1] = "start", 
                    E.foldWidgets[N + 1] = "", "";
                    return E.foldWidgets[N - 1] = -1 != n && n < T ? "start" : "", T < R ? "start" : "";
                };
            }.call(O.prototype);
        }), ace.define("ace/mode/abap", [ "require", "exports", "module", "ace/mode/abap_highlight_rules", "ace/mode/folding/coffee", "ace/range", "ace/mode/text", "ace/lib/oop" ], function(E, e, N) {
            "use strict";
            function Mode() {
                this.HighlightRules = t, this.foldingRules = new T();
            }
            var t = E("./abap_highlight_rules").AbapHighlightRules, T = E("./folding/coffee").FoldMode, I = (E("../range").Range, 
            E("./text").Mode);
            E("../lib/oop").inherits(Mode, I), function() {
                this.lineCommentStart = '"', this.getNextLineIndent = function(E, e, N) {
                    return this.$getIndent(e);
                }, this.$id = "ace/mode/abap";
            }.call(Mode.prototype), e.Mode = Mode;
        });
    }
});
