flklrJsonp([ 108 ], {
    100: function(e, t) {
        ace.define("ace/mode/doc_comment_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            var i = e("../lib/oop"), r = (e("../lib/lang"), e("./doc_comment_highlight_rules").DocCommentHighlightRules), o = e("./text_highlight_rules").TextHighlightRules, a = function() {
                function string(e) {
                    var t = e.start;
                    return {
                        token: "string.start",
            ...
            i.inherits(a, o), t.MysqlHighlightRules = a;
        }), ace.define("ace/mode/mysql", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/mysql_highlight_rules" ], function(e, t, n) {
            var i = e("../lib/oop"), r = e("../mode/text").Mode, o = e("./mysql_highlight_rules").MysqlHighlightRules, a = function() {
