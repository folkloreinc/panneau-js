flklrJsonp([ 77 ], {
    139: function(e, t) {
        ace.define("ace/mode/css_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            r.inherits(x, o), t.CssHighlightRules = x;
            ...
            var r = e("../lib/oop"), o = e("./doc_comment_highlight_rules").DocCommentHighlightRules, a = e("./text_highlight_rules").TextHighlightRules, i = "[a-zA-Z\\$_¡-￿][a-zA-Z\\d\\$_¡-￿]*\\b", s = function(e) {
                ...
                this.$rules = {
                    ...
                    onMatch: function(e, t, n) {
                        ...
                        "paren") : "}" == e && n.length && (n.shift(), this.next = n.shift(), -1 != this.next.indexOf("string") || -1 != this.next.indexOf("jsx")) ? "paren.quasi.end" : "{" == e ? "paren.lparen" : "paren.rparen";
                    },
                    nextState: "start"
                }, {
                ...
                }), e && e.noJSX || JSX.call(this)), this.embedRules(o, "doc-", [ o.getEndRule("no_regex") ]), 
                this.normalizeRules();
            };
            ...
            "use strict";
            var r = e("../lib/oop"), o = (e("../lib/lang"), e("./html_highlight_rules").HtmlHighlightRules), a = e("./text_highlight_rules").TextHighlightRules, i = function() {
                o.call(this);
                ...
                var t = this.createKeywordMapper({
                    ...
                    "support.function.swig": "addslashes|capitalize|date|default|escape|first|groupBy|join|json|last|lower|raw|replace|reverse|safe|sort|striptags|title|uniq|upper|url_encode|url_decode|first|last|index|index0|revindex|revindex0|key",
                    "keyword.operator.swig": "in|is|and|or|not|as|with|only",
                    "constant.language.swig": "null|none|true|false|loop"
                }, "identifier");
            ...
            r.inherits(i, a), t.SwigHighlightRules = i;
        });
    }
});
