        ...
        ace.define("ace/mode/textile_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            var i = e("../lib/oop"), r = e("./text_highlight_rules").TextHighlightRules, o = function() {
                this.$rules = {
                    start: [ {
                        token: function(e) {
                            return "h" == e.charAt(0) ? "markup.heading." + e.charAt(1) : "markup.heading";
                        },
            ...
            i.inherits(o, r), t.TextileHighlightRules = o;
            ...
            (function() {
                this.checkOutdent = function(e, t) {
                    ...
                    if (!r) return 0;
                    var o = r[1].length, h = e.findMatchingBracket({
                        row: t,
                        column: o
                    });
                    if (!h || h.row == t) return 0;
                    var c = this.$getIndent(e.getLine(h.row));
                    e.replace(new i(t, 0, t, o - 1), c);
            ...
            "use strict";
            var i = e("../lib/oop"), r = e("./text").Mode, o = e("./textile_highlight_rules").TextileHighlightRules, h = e("./matching_brace_outdent").MatchingBraceOutdent, c = function() {
                this.HighlightRules = o, this.$outdent = new h(), this.$behaviour = this.$defaultBehaviour;
            };
