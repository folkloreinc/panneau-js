flklrJsonp([ 149 ], {
    47: function(e, t) {
        ace.define("ace/mode/forth_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, o) {
            "use strict";
            var n = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, r = function() {
                this.$rules = {
                    start: [ {
                        include: "#forth"
                    } ],
            ...
            }, n.inherits(r, i), t.ForthHighlightRules = r;
            ...
            "use strict";
            var n = e("../../lib/oop"), i = e("../../range").Range, r = e("./fold_mode").FoldMode, s = t.FoldMode = function(e) {
            ...
            n.inherits(s, r), function() {
                ...
                this.getFoldWidget = function(e, t, o) {
                    ...
                    if (r) {
                        var s = r.index;
                        if (r[1]) return this.openingBracketBlock(e, r[1], o, s);
                        var l = e.getCommentFoldRange(o, s + r[0].length, 1);
                        return l && !l.isMultiLine() && (n ? l = this.getSectionRange(e, o) : "all" != t && (l = null)), 
                        l;
                    }
                    if ("markbegin" !== t) {
                        ...
                        if (r) {
                            ...
                            return r[1] ? this.closingBracketBlock(e, r[1], o, s) : e.getCommentFoldRange(o, s, -1);
                        }
                    }
                }, this.getSectionRange = function(e, t) {
                    var o = e.getLine(t), n = o.search(/\S/), r = t, s = o.length;
                    t += 1;
                    ...
                    for (var n = t.search(/\s*$/), r = e.getLength(), s = o, l = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, a = 1; ++o < r; ) {
                        t = e.getLine(o);
                        var c = l.exec(t);
                        if (c && (c[1] ? a-- : a++, !a)) break;
                    }
                    var h = o;
                    if (h > s) return new i(s, n, h, t.length);
                };
            }.call(s.prototype);
        }), ace.define("ace/mode/forth", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/forth_highlight_rules", "ace/mode/folding/cstyle" ], function(e, t, o) {
            "use strict";
            var n = e("../lib/oop"), i = e("./text").Mode, r = e("./forth_highlight_rules").ForthHighlightRules, s = e("./folding/cstyle").FoldMode, l = function() {
                this.HighlightRules = r, this.foldingRules = new s(), this.$behaviour = this.$defaultBehaviour;
            };
