flklrJsonp([ 109 ], {
    99: function(e, t) {
        ...
        }), ace.define("ace/mode/folding/pythonic", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode" ], function(e, t, r) {
            "use strict";
            var o = e("../../lib/oop"), a = e("./fold_mode").FoldMode, i = t.FoldMode = function(e) {
                this.foldingStartMarker = new RegExp("([\\[{])(?:\\s*)$|(" + e + ")(?:\\s*)(?:#.*)?$");
            };
            o.inherits(i, a), function() {
                this.getFoldWidgetRange = function(e, t, r) {
                    var o = e.getLine(r), a = o.match(this.foldingStartMarker);
                    if (a) return a[1] ? this.openingBracketBlock(e, a[1], r, a.index) : a[2] ? this.indentationBlock(e, r, a.index + a[2].length) : this.indentationBlock(e, r);
                };
            }.call(i.prototype);
        }), ace.define("ace/mode/mushcode", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/mushcode_highlight_rules", "ace/mode/folding/pythonic", "ace/range" ], function(e, t, r) {
            "use strict";
            var o = e("../lib/oop"), a = e("./text").Mode, i = e("./mushcode_highlight_rules").MushCodeRules, n = e("./folding/pythonic").FoldMode, s = e("../range").Range, l = function() {
                this.HighlightRules = i, this.foldingRules = new n("\\:"), this.$behaviour = this.$defaultBehaviour;
            };
            o.inherits(l, a), function() {
                this.getNextLineIndent = function(e, t, r) {
                    var o = this.$getIndent(t), a = this.getTokenizer().getLineTokens(t, e), i = a.tokens;
                ...
                this.checkOutdent = function(t, r, o) {
                    ...
                    do {
                        var i = a.pop();
                    } while (i && ("comment" == i.type || "text" == i.type && i.value.match(/^\s+$/)));
                    return !!i && ("keyword" == i.type && e[i.value]);
                }, this.autoOutdent = function(e, t, r) {
                    r += 1;
                    var o = this.$getIndent(t.getLine(r)), a = t.getTabString();
                    o.slice(-a.length) == a && t.remove(new s(r, o.length - a.length, r, o.length));
