flklrJsonp([ 122 ], {
    83: function(e, t) {
        ace.define("ace/mode/live_script_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, i) {
            "use strict";
            ...
            }, n.inherits(o, r), t.LiveScriptHighlightRules = o;
            ...
            n.inherits(s, o), function() {
                ...
                this.getFoldWidget = function(e, t, i) {
                    ...
                    for (var a = t, l = e.getLength(); ++t < l; ) {
                        ...
                        if (-1 !== c) {
                            if (n > c) break;
                            var p = this.getFoldWidgetRange(e, "all", t);
                            if (p) {
                                if (p.start.row <= o) break;
                                if (p.isMultiLine()) t = p.end.row; else if (n == c) break;
                            }
                            a = t;
                        }
                    }
                    ...
                    var p = i;
                    if (p > s) return new r(s, n, p, t.length);
                };
            }.call(s.prototype);
        }), ace.define("ace/mode/live_script", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/live_script_highlight_rules", "ace/mode/folding/cstyle" ], function(e, t, i) {
            "use strict";
            var n = e("../lib/oop"), r = e("./text").Mode, o = e("./live_script_highlight_rules").LiveScriptHighlightRules, s = e("./folding/cstyle").FoldMode, a = function() {
...
//# sourceMappingURL=live_script.js.map