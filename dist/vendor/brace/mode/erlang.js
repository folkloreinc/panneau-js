flklrJsonp([ 150 ], {
    46: function(e, n) {
        ace.define("ace/mode/erlang_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, n, t) {
            "use strict";
            var r = e("../lib/oop"), a = e("./text_highlight_rules").TextHighlightRules, i = function() {
                this.$rules = {
                    start: [ {
            ...
            }, r.inherits(i, a), n.ErlangHighlightRules = i;
        }), ace.define("ace/mode/folding/cstyle", [ "require", "exports", "module", "ace/lib/oop", "ace/range", "ace/mode/folding/fold_mode" ], function(e, n, t) {
            "use strict";
            var r = e("../../lib/oop"), a = e("../../range").Range, i = e("./fold_mode").FoldMode, o = n.FoldMode = function(e) {
            ...
            r.inherits(o, i), function() {
                ...
                this.getFoldWidget = function(e, n, t) {
                    ...
                    var a = e.getLine(t);
                    if (this.startRegionRe.test(a)) return this.getCommentRegionBlock(e, a, t);
                    var i = a.match(this.foldingStartMarker);
                    if (i) {
                        var o = i.index;
                        if (i[1]) return this.openingBracketBlock(e, i[1], t, o);
                        var g = e.getCommentFoldRange(t, o + i[0].length, 1);
                        return g && !g.isMultiLine() && (r ? g = this.getSectionRange(e, t) : "all" != n && (g = null)), 
                        g;
                    }
                    if ("markbegin" !== n) {
                        var i = a.match(this.foldingStopMarker);
                        if (i) {
                            var o = i.index + i[0].length;
                            return i[1] ? this.closingBracketBlock(e, i[1], t, o) : e.getCommentFoldRange(t, o, -1);
                        }
                    }
                }, this.getSectionRange = function(e, n) {
                    var t = e.getLine(n), r = t.search(/\S/), i = n, o = t.length;
                    n += 1;
                    for (var g = n, l = e.getLength(); ++n < l; ) {
                        t = e.getLine(n);
                        var c = t.search(/\S/);
                        if (-1 !== c) {
                            if (r > c) break;
                            ...
                            if (s) {
                                ...
                                if (s.isMultiLine()) n = s.end.row; else if (r == c) break;
                            }
                            g = n;
                        }
                    }
                    ...
                    for (var r = n.search(/\s*$/), i = e.getLength(), o = t, g = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, l = 1; ++t < i; ) {
                        n = e.getLine(t);
                        var c = g.exec(n);
                        if (c && (c[1] ? l-- : l++, !l)) break;
                    }
                    var s = t;
                    if (s > o) return new a(o, r, s, n.length);
                };
            }.call(o.prototype);
        }), ace.define("ace/mode/erlang", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/erlang_highlight_rules", "ace/mode/folding/cstyle" ], function(e, n, t) {
            "use strict";
            var r = e("../lib/oop"), a = e("./text").Mode, i = e("./erlang_highlight_rules").ErlangHighlightRules, o = e("./folding/cstyle").FoldMode, g = function() {
                this.HighlightRules = i, this.foldingRules = new o(), this.$behaviour = this.$defaultBehaviour;
            };
            r.inherits(g, a), function() {
