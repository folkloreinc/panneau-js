flklrJsonp([ 103 ], {
    105: function(e, t) {
        ace.define("ace/mode/pascal_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            o.inherits(a, i), t.PascalHighlightRules = a;
            ...
            "use strict";
            var o = e("../../lib/oop"), i = e("./fold_mode").FoldMode, a = e("../../range").Range, r = t.FoldMode = function() {};
            o.inherits(r, i), function() {
                this.getFoldWidgetRange = function(e, t, n) {
                    var o = this.indentationBlock(e, n);
                    if (o) return o;
                    var i = /\S/, r = e.getLine(n), s = r.search(i);
                    if (-1 != s && "#" == r[s]) {
                        for (var l = r.length, c = e.getLength(), p = n, u = n; ++n < c; ) {
                            r = e.getLine(n);
                            var d = r.search(i);
                            if (-1 != d) {
                                if ("#" != r[d]) break;
                        ...
                        if (u > p) {
                            ...
                            return new a(p, l, u, g);
                        }
                    }
                }, this.getFoldWidget = function(e, t, n) {
                    var o = e.getLine(n), i = o.search(/\S/), a = e.getLine(n + 1), r = e.getLine(n - 1), s = r.search(/\S/), l = a.search(/\S/);
                    if (-1 == i) return e.foldWidgets[n - 1] = -1 != s && s < l ? "start" : "", "";
                    if (-1 == s) {
                        if (i == l && "#" == o[i] && "#" == a[i]) return e.foldWidgets[n - 1] = "", e.foldWidgets[n + 1] = "", 
                        "start";
                    } else if (s == i && "#" == o[i] && "#" == r[i] && -1 == e.getLine(n - 2).search(/\S/)) return e.foldWidgets[n - 1] = "start", 
                    e.foldWidgets[n + 1] = "", "";
                    return e.foldWidgets[n - 1] = -1 != s && s < i ? "start" : "", i < l ? "start" : "";
                };
            }.call(r.prototype);
            ...
            "use strict";
            var o = e("../lib/oop"), i = e("./text").Mode, a = e("./pascal_highlight_rules").PascalHighlightRules, r = e("./folding/coffee").FoldMode, s = function() {
