flklrJsonp([ 110 ], {
    98: function(e, t) {
        ace.define("ace/mode/mipsassembler_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, i) {
            "use strict";
            var r = e("../lib/oop"), n = e("./text_highlight_rules").TextHighlightRules, s = function() {
                this.$rules = {
                    start: [ {
                        token: "string.start",
                        regex: '"',
            ...
            s.metaData = r.inherits(s, n), t.mipsassemblerHighlightRules = s;
            ...
            "use strict";
            var r = e("../../lib/oop"), n = e("../../range").Range, s = e("./fold_mode").FoldMode, o = t.FoldMode = function(e) {
            ...
            r.inherits(o, s), function() {
                ...
                this.getFoldWidget = function(e, t, i) {
                    ...
                    if (s) {
                        ...
                        var l = e.getCommentFoldRange(i, o + s[0].length, 1);
                        return l && !l.isMultiLine() && (r ? l = this.getSectionRange(e, i) : "all" != t && (l = null)), 
                        l;
                    }
                    if ("markbegin" !== t) {
                        ...
                        if (s) {
                            ...
                            return s[1] ? this.closingBracketBlock(e, s[1], i, o) : e.getCommentFoldRange(i, o, -1);
                        }
                    }
                }, this.getSectionRange = function(e, t) {
                    var i = e.getLine(t), r = i.search(/\S/), s = t, o = i.length;
                    t += 1;
                    for (var l = t, a = e.getLength(); ++t < a; ) {
                        ...
                        if (-1 !== g) {
                            ...
                            if (h) {
                                ...
                                if (h.isMultiLine()) t = h.end.row; else if (r == g) break;
                            }
                            l = t;
                        }
                    }
                    return new n(s, o, l, e.getLine(l).length);
                }, this.getCommentRegionBlock = function(e, t, i) {
                    for (var r = t.search(/\s*$/), s = e.getLength(), o = i, l = /^\s*(?:\/\*|\/\/)#(end)?region\b/, a = 1; ++i < s; ) {
                        t = e.getLine(i);
                        var g = l.exec(t);
                        if (g && (g[1] ? a-- : a++, !a)) break;
                    }
                    var h = i;
                    if (h > o) return new n(o, r, h, t.length);
                };
            }.call(o.prototype);
        }), ace.define("ace/mode/mipsassembler", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/mipsassembler_highlight_rules", "ace/mode/folding/cstyle" ], function(e, t, i) {
            "use strict";
            var r = e("../lib/oop"), n = e("./text").Mode, s = e("./mipsassembler_highlight_rules").HighlightRules, o = e("./folding/cstyle").FoldMode, l = function() {
...
//# sourceMappingURL=mipsassembler.js.map