flklrJsonp([ 105 ], {
    103: function(e, t) {
        ace.define("ace/mode/doc_comment_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, r) {
            "use strict";
            var n = e("../lib/oop"), o = e("./text_highlight_rules").TextHighlightRules, i = function() {
                this.$rules = {
                    start: [ {
            ...
            n.inherits(i, o), i.getTagRule = function(e) {
                return {
            ...
            n.inherits(l, i), t.c_cppHighlightRules = l;
        }), ace.define("ace/mode/objectivec_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/doc_comment_highlight_rules", "ace/mode/c_cpp_highlight_rules" ], function(e, t, r) {
            "use strict";
            var n = e("../lib/oop"), o = e("./doc_comment_highlight_rules").DocCommentHighlightRules, i = e("./c_cpp_highlight_rules"), a = i.c_cppHighlightRules, l = function() {
                ...
                for (var l in n) this.$rules[l] ? this.$rules[l].push && this.$rules[l].push.apply(this.$rules[l], n[l]) : this.$rules[l] = n[l];
            ...
            n.inherits(l, a), t.ObjectiveCHighlightRules = l;
            ...
            "use strict";
            var n = e("../../lib/oop"), o = e("../../range").Range, i = e("./fold_mode").FoldMode, a = t.FoldMode = function(e) {
            ...
            n.inherits(a, i), function() {
                ...
                this.getFoldWidget = function(e, t, r) {
                    ...
                    var o = e.getLine(r);
                    if (this.startRegionRe.test(o)) return this.getCommentRegionBlock(e, o, r);
                    var i = o.match(this.foldingStartMarker);
                    if (i) {
                        var a = i.index;
                        if (i[1]) return this.openingBracketBlock(e, i[1], r, a);
                        var l = e.getCommentFoldRange(r, a + i[0].length, 1);
                        return l && !l.isMultiLine() && (n ? l = this.getSectionRange(e, r) : "all" != t && (l = null)), 
                        l;
                    }
                    if ("markbegin" !== t) {
                        ...
                        if (i) {
                            ...
                            return i[1] ? this.closingBracketBlock(e, i[1], r, a) : e.getCommentFoldRange(r, a, -1);
                        }
                    }
                }, this.getSectionRange = function(e, t) {
                    var r = e.getLine(t), n = r.search(/\S/), i = t, a = r.length;
                    t += 1;
                    for (var l = t, c = e.getLength(); ++t < c; ) {
                        r = e.getLine(t);
                        var s = r.search(/\S/);
                        if (-1 !== s) {
                            if (n > s) break;
                            ...
                            if (d) {
                                ...
                                if (d.isMultiLine()) t = d.end.row; else if (n == s) break;
                            }
                            l = t;
                        }
                    }
                    ...
                    for (var n = t.search(/\s*$/), i = e.getLength(), a = r, l = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, c = 1; ++r < i; ) {
                        t = e.getLine(r);
                        var s = l.exec(t);
        ...
        }), ace.define("ace/mode/objectivec", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/objectivec_highlight_rules", "ace/mode/folding/cstyle" ], function(e, t, r) {
            "use strict";
            var n = e("../lib/oop"), o = e("./text").Mode, i = e("./objectivec_highlight_rules").ObjectiveCHighlightRules, a = e("./folding/cstyle").FoldMode, l = function() {
