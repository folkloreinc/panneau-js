flklrJsonp([ 106 ], {
    102: function(e, t) {
        ace.define("ace/mode/nsis_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            "use strict";
            var i = e("../lib/oop"), s = e("./text_highlight_rules").TextHighlightRules, o = function() {
                this.$rules = {
                    start: [ {
            ...
            }, i.inherits(o, s), t.NSISHighlightRules = o;
        }), ace.define("ace/mode/folding/cstyle", [ "require", "exports", "module", "ace/lib/oop", "ace/range", "ace/mode/folding/fold_mode" ], function(e, t, n) {
            "use strict";
            var i = e("../../lib/oop"), s = e("../../range").Range, o = e("./fold_mode").FoldMode, r = t.FoldMode = function(e) {
            ...
            i.inherits(r, o), function() {
                ...
                this.getFoldWidget = function(e, t, n) {
                    ...
                    var s = e.getLine(n);
                    if (this.startRegionRe.test(s)) return this.getCommentRegionBlock(e, s, n);
                    var o = s.match(this.foldingStartMarker);
                    if (o) {
                        var r = o.index;
                        if (o[1]) return this.openingBracketBlock(e, o[1], n, r);
                        var a = e.getCommentFoldRange(n, r + o[0].length, 1);
                        return a && !a.isMultiLine() && (i ? a = this.getSectionRange(e, n) : "all" != t && (a = null)), 
                        a;
                    }
                    if ("markbegin" !== t) {
                        var o = s.match(this.foldingStopMarker);
                        if (o) {
                            var r = o.index + o[0].length;
                            return o[1] ? this.closingBracketBlock(e, o[1], n, r) : e.getCommentFoldRange(n, r, -1);
                        }
                    }
                }, this.getSectionRange = function(e, t) {
                    var n = e.getLine(t), i = n.search(/\S/), o = t, r = n.length;
                    t += 1;
                    ...
                    for (var i = t.search(/\s*$/), o = e.getLength(), r = n, a = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, l = 1; ++n < o; ) {
                        t = e.getLine(n);
                        var g = a.exec(t);
                        if (g && (g[1] ? l-- : l++, !l)) break;
                    }
                    var c = n;
                    if (c > r) return new s(r, i, c, t.length);
                };
            }.call(r.prototype);
            ...
            "use strict";
            var i = e("../lib/oop"), s = e("./text").Mode, o = e("./nsis_highlight_rules").NSISHighlightRules, r = e("./folding/cstyle").FoldMode, a = function() {
                this.HighlightRules = o, this.foldingRules = new r(), this.$behaviour = this.$defaultBehaviour;
            };
            i.inherits(a, s), function() {
