flklrJsonp([ 171 ], {
    19: function(e, t) {
        ace.define("ace/mode/applescript_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, i) {
            "use strict";
            var r = e("../lib/oop"), o = e("./text_highlight_rules").TextHighlightRules, n = function() {
            ...
            r.inherits(n, o), t.AppleScriptHighlightRules = n;
            ...
            "use strict";
            var r = e("../../lib/oop"), o = e("../../range").Range, n = e("./fold_mode").FoldMode, a = t.FoldMode = function(e) {
            ...
            r.inherits(a, n), function() {
                ...
                this.getFoldWidget = function(e, t, i) {
                    ...
                    var n = o.match(this.foldingStartMarker);
                    if (n) {
                        var a = n.index;
                        if (n[1]) return this.openingBracketBlock(e, n[1], i, a);
                        var s = e.getCommentFoldRange(i, a + n[0].length, 1);
                        return s && !s.isMultiLine() && (r ? s = this.getSectionRange(e, i) : "all" != t && (s = null)), 
                        s;
                    }
                    if ("markbegin" !== t) {
                        var n = o.match(this.foldingStopMarker);
                        if (n) {
                            var a = n.index + n[0].length;
                            return n[1] ? this.closingBracketBlock(e, n[1], i, a) : e.getCommentFoldRange(i, a, -1);
                        }
                    }
                }, this.getSectionRange = function(e, t) {
                    var i = e.getLine(t), r = i.search(/\S/), n = t, a = i.length;
                    t += 1;
                    ...
                    return new o(n, a, s, e.getLine(s).length);
                }, this.getCommentRegionBlock = function(e, t, i) {
                    for (var r = t.search(/\s*$/), n = e.getLength(), a = i, s = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, l = 1; ++i < n; ) {
                        t = e.getLine(i);
                        var g = s.exec(t);
        ...
        }), ace.define("ace/mode/applescript", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/applescript_highlight_rules", "ace/mode/folding/cstyle" ], function(e, t, i) {
            "use strict";
            var r = e("../lib/oop"), o = e("./text").Mode, n = e("./applescript_highlight_rules").AppleScriptHighlightRules, a = e("./folding/cstyle").FoldMode, s = function() {
