flklrJsonp([ 86 ], {
    126: function(e, t) {
        ace.define("ace/mode/scheme_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            }).call(r.prototype), t.MatchingParensOutdent = r;
            ...
            "use strict";
            var i = e("../lib/oop"), r = e("./text").Mode, o = e("./scheme_highlight_rules").SchemeHighlightRules, s = e("./matching_parens_outdent").MatchingParensOutdent, a = function() {
                this.HighlightRules = o, this.$outdent = new s(), this.$behaviour = this.$defaultBehaviour;
            };
            i.inherits(a, r), function() {
                this.lineCommentStart = ";", this.minorIndentFunctions = [ "define", "lambda", "define-macro", "define-syntax", "syntax-rules", "define-record-type", "define-structure" ], 
                this.$toIndent = function(e) {
                    return e.split("").map(function(e) {
                        return /\s/.exec(e) ? e : " ";
                    }).join("");
                }, this.$calculateIndent = function(e, t) {
                    for (var n, i, r = this.$getIndent(e), o = 0, s = e.length - 1; s >= 0 && (i = e[s], 
                    "(" === i ? (o--, n = !0) : "(" === i || "[" === i || "{" === i ? (o--, n = !1) : ")" !== i && "]" !== i && "}" !== i || o++, 
                    !(o < 0)); s--) ;
                    if (!(o < 0 && n)) return o < 0 && !n ? this.$toIndent(e.substring(0, s + 1)) : o > 0 ? r = r.substring(0, r.length - t.length) : r;
                    s += 1;
                    for (var a = s, c = ""; ;) {
                        if (" " === (i = e[s]) || "\t" === i) return -1 !== this.minorIndentFunctions.indexOf(c) ? this.$toIndent(e.substring(0, a - 1) + t) : this.$toIndent(e.substring(0, s + 1));
                        if (void 0 === i) return this.$toIndent(e.substring(0, a - 1) + t);
                        c += e[s], s++;
                    }
