flklrJsonp([ 101 ], {
    107: function(e, t) {
        ace.define("ace/mode/doc_comment_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            "use strict";
            var a = e("../lib/oop"), r = e("./text_highlight_rules").TextHighlightRules, i = function() {
                this.$rules = {
                    start: [ {
            ...
            a.inherits(i, r), i.getTagRule = function(e) {
                return {
            ...
            a.inherits(i, r), t.PerlHighlightRules = i;
            ...
            var a = e("../lib/oop"), r = e("./text_highlight_rules").TextHighlightRules, i = function() {
                ...
                }, "identifier"), t = "(?:r|u|ur|R|U|UR|Ur|uR)?", n = "(?:(?:(?:[1-9]\\d*)|(?:0))|(?:0[oO]?[0-7]+)|(?:0[xX][\\dA-Fa-f]+)|(?:0[bB][01]+))", a = "(?:(?:(?:\\d+)?(?:\\.\\d+))|(?:(?:\\d+)\\.))", r = "(?:(?:(?:(?:(?:(?:\\d+)?(?:\\.\\d+))|(?:(?:\\d+)\\.))|(?:\\d+))(?:[eE][+-]?\\d+))|" + a + ")", i = "\\\\(x[0-9A-Fa-f]{2}|[0-7]{3}|[\\\\abfnrtv'\"]|U[0-9A-Fa-f]{8}|u[0-9A-Fa-f]{4})";
                this.$rules = {
                    start: [ {
                        token: "comment",
                        regex: "#.*$"
            ...
            a.inherits(i, r), t.PythonHighlightRules = i;
            ...
            a.inherits(i, r), t.JsonHighlightRules = i;
            ...
            "use strict";
            function JSX() {
                var e = _.replace("\\d", "\\d\\-"), t = {
                    onMatch: function(e, t, n) {
                        var a = "/" == e.charAt(1) ? 2 : 1;
                        return 1 == a ? (t != this.nextState ? n.unshift(this.next, this.nextState, 0) : n.unshift(this.next), 
                        n[2]++) : 2 == a && t == this.nextState && (!--n[1] || n[1] < 0) && (n.shift(), 
                        n.shift()), [ {
                            type: "meta.tag.punctuation." + (1 == a ? "" : "end-") + "tag-open.xml",
                            value: e.slice(0, a)
                        }, {
            ...
            var a = e("../lib/oop"), r = e("./doc_comment_highlight_rules").DocCommentHighlightRules, i = e("./text_highlight_rules").TextHighlightRules, _ = "[a-zA-Z\\$_¡-￿][a-zA-Z\\d\\$_¡-￿]*", o = function(e) {
                ...
                this.$rules = {
                    no_regex: [ r.getStartRule("doc-start"), comments("no_regex"), {
                        token: "string",
                        regex: "'(?=.)",
                        next: "qstring"
                    }, {
                        ...
                        regex: "(" + _ + ")(\\.)(" + _ + ")(\\s*)(=)(\\s*)(function)(\\s+)(\\w+)(\\s*)(\\()",
                        next: "function_arguments"
                    }, {
                        token: [ "storage.type", "text", "entity.name.function", "text", "paren.lparen" ],
                        regex: "(function)(\\s+)(" + _ + ")(\\s*)(\\()",
                        next: "function_arguments"
                    }, {
                    ...
                    start: [ r.getStartRule("doc-start"), comments("start"), {
                        token: "string.regexp",
                        regex: "\\/",
                        next: "regex"
                    }, {
                ...
                }), e && 0 == e.jsx || JSX.call(this)), this.embedRules(r, "doc-", [ r.getEndRule("no_regex") ]), 
                this.normalizeRules();
            };
            a.inherits(o, i), t.JavaScriptHighlightRules = o;
            ...
            var a = e("../lib/oop"), r = (e("../lib/lang"), e("./doc_comment_highlight_rules").DocCommentHighlightRules), i = e("./text_highlight_rules").TextHighlightRules, _ = e("./perl_highlight_rules").PerlHighlightRules, o = e("./python_highlight_rules").PythonHighlightRules, s = e("./json_highlight_rules").JsonHighlightRules, l = e("./javascript_highlight_rules").JavaScriptHighlightRules, c = function() {
                ...
                }, this.embedRules(r, "doc-", [ r.getEndRule("start") ]), this.embedRules(_, "perl-", [ {
                    token: "string",
                    regex: "\\$perl\\$",
                    next: "statement"
                } ]), this.embedRules(o, "python-", [ {
                    token: "string",
                    regex: "\\$python\\$",
                    next: "statement"
                } ]), this.embedRules(s, "json-", [ {
                    token: "string",
                    regex: "\\$json\\$",
                    next: "statement"
