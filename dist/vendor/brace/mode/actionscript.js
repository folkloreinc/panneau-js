flklrJsonp([ 174 ], {
    16: function(e, t) {
        ace.define("ace/mode/actionscript_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, o) {
            "use strict";
            var i = e("../lib/oop"), n = e("./text_highlight_rules").TextHighlightRules, a = function() {
                this.$rules = {
                    start: [ {
            ...
            }, i.inherits(a, n), t.ActionScriptHighlightRules = a;
            ...
            "use strict";
            var i = e("../../lib/oop"), n = e("../../range").Range, a = e("./fold_mode").FoldMode, r = t.FoldMode = function(e) {
            ...
            i.inherits(r, a), function() {
                ...
                this.getFoldWidget = function(e, t, o) {
                    ...
                    if (a) {
                        ...
                        return l && !l.isMultiLine() && (i ? l = this.getSectionRange(e, o) : "all" != t && (l = null)), 
                        l;
                    }
                    if ("markbegin" !== t) {
                        ...
                        if (a) {
                            ...
                            return a[1] ? this.closingBracketBlock(e, a[1], o, r) : e.getCommentFoldRange(o, r, -1);
                        }
                    }
                }, this.getSectionRange = function(e, t) {
                    var o = e.getLine(t), i = o.search(/\S/), a = t, r = o.length;
                    t += 1;
                    for (var l = t, s = e.getLength(); ++t < s; ) {
                        ...
                        if (-1 !== d) {
                            ...
                            if (c) {
                                ...
                                if (c.isMultiLine()) t = c.end.row; else if (i == d) break;
                            }
                            l = t;
                        }
                    }
                    ...
                    for (var i = t.search(/\s*$/), a = e.getLength(), r = o, l = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, s = 1; ++o < a; ) {
                        t = e.getLine(o);
                        var d = l.exec(t);
                        if (d && (d[1] ? s-- : s++, !s)) break;
                    }
                    var c = o;
                    if (c > r) return new n(r, i, c, t.length);
                };
            }.call(r.prototype);
        }), ace.define("ace/mode/actionscript", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/actionscript_highlight_rules", "ace/mode/folding/cstyle" ], function(e, t, o) {
            "use strict";
            var i = e("../lib/oop"), n = e("./text").Mode, a = e("./actionscript_highlight_rules").ActionScriptHighlightRules, r = e("./folding/cstyle").FoldMode, l = function() {
                this.HighlightRules = a, this.foldingRules = new r(), this.$behaviour = this.$defaultBehaviour;
            };
