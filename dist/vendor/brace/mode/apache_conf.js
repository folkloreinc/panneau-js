flklrJsonp([ 172 ], {
    18: function(e, t) {
        ace.define("ace/mode/apache_conf_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, a) {
            "use strict";
            var o = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, r = function() {
                this.$rules = {
                    start: [ {
            ...
            }, o.inherits(r, i), t.ApacheConfHighlightRules = r;
            ...
            "use strict";
            var o = e("../../lib/oop"), i = e("../../range").Range, r = e("./fold_mode").FoldMode, n = t.FoldMode = function(e) {
            ...
            o.inherits(n, r), function() {
                ...
                this.getFoldWidget = function(e, t, a) {
                ...
                }, this.getFoldWidgetRange = function(e, t, a, o) {
                    var i = e.getLine(a);
                    if (this.startRegionRe.test(i)) return this.getCommentRegionBlock(e, i, a);
                    var r = i.match(this.foldingStartMarker);
                    if (r) {
                        var n = r.index;
                        if (r[1]) return this.openingBracketBlock(e, r[1], a, n);
                        var c = e.getCommentFoldRange(a, n + r[0].length, 1);
                        return c && !c.isMultiLine() && (o ? c = this.getSectionRange(e, a) : "all" != t && (c = null)), 
                        c;
                    }
                    if ("markbegin" !== t) {
                        ...
                        if (r) {
                            ...
                            return r[1] ? this.closingBracketBlock(e, r[1], a, n) : e.getCommentFoldRange(a, n, -1);
                        }
                    }
                }, this.getSectionRange = function(e, t) {
                    var a = e.getLine(t), o = a.search(/\S/), r = t, n = a.length;
                    t += 1;
                    for (var c = t, s = e.getLength(); ++t < s; ) {
                        a = e.getLine(t);
                        var h = a.search(/\S/);
                        if (-1 !== h) {
                            if (o > h) break;
                            ...
                            if (l) {
                                ...
                                if (l.isMultiLine()) t = l.end.row; else if (o == h) break;
                            }
                            c = t;
                        }
                    }
                    ...
                    for (var o = t.search(/\s*$/), r = e.getLength(), n = a, c = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, s = 1; ++a < r; ) {
                        t = e.getLine(a);
                        var h = c.exec(t);
                        if (h && (h[1] ? s-- : s++, !s)) break;
                    }
                    var l = a;
                    if (l > n) return new i(n, o, l, t.length);
                };
            }.call(n.prototype);
        }), ace.define("ace/mode/apache_conf", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/apache_conf_highlight_rules", "ace/mode/folding/cstyle" ], function(e, t, a) {
            "use strict";
            var o = e("../lib/oop"), i = e("./text").Mode, r = e("./apache_conf_highlight_rules").ApacheConfHighlightRules, n = e("./folding/cstyle").FoldMode, c = function() {
                this.HighlightRules = r, this.foldingRules = new n(), this.$behaviour = this.$defaultBehaviour;
            };
