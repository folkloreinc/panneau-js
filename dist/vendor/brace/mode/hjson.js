flklrJsonp([ 137 ], {
    62: function(e, t) {
        ace.define("ace/mode/hjson_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            }, o.inherits(r, i), t.HjsonHighlightRules = r;
            ...
            o.inherits(a, r), function() {
                ...
                this.getFoldWidget = function(e, t, n) {
                    ...
                    for (var s = t, l = e.getLength(); ++t < l; ) {
                        ...
                        if (-1 !== g) {
                            ...
                            if (c) {
                                ...
                                if (c.isMultiLine()) t = c.end.row; else if (o == g) break;
                            }
                            s = t;
                        }
                    }
                    ...
                    for (var o = t.search(/\s*$/), r = e.getLength(), a = n, s = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, l = 1; ++n < r; ) {
                        t = e.getLine(n);
                        var g = s.exec(t);
            ...
            "use strict";
            var o = e("../lib/oop"), i = e("./text").Mode, r = e("./hjson_highlight_rules").HjsonHighlightRules, a = e("./folding/cstyle").FoldMode, s = function() {
