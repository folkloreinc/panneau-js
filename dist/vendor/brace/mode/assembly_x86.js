flklrJsonp([ 169 ], {
    21: function(s, e) {
        ace.define("ace/mode/assembly_x86_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(s, e, t) {
            "use strict";
            var d = s("../lib/oop"), p = s("./text_highlight_rules").TextHighlightRules, n = function() {
                this.$rules = {
                    start: [ {
            ...
            }, d.inherits(n, p), e.AssemblyX86HighlightRules = n;
        }), ace.define("ace/mode/folding/coffee", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode", "ace/range" ], function(s, e, t) {
            "use strict";
            var d = s("../../lib/oop"), p = s("./fold_mode").FoldMode, n = s("../../range").Range, i = e.FoldMode = function() {};
            d.inherits(i, p), function() {
                this.getFoldWidgetRange = function(s, e, t) {
                    var d = this.indentationBlock(s, t);
                    if (d) return d;
                    var p = /\S/, i = s.getLine(t), a = i.search(p);
                    if (-1 != a && "#" == i[a]) {
                        for (var o = i.length, r = s.getLength(), c = t, m = t; ++t < r; ) {
                            i = s.getLine(t);
                            var l = i.search(p);
                            if (-1 != l) {
                                if ("#" != i[l]) break;
                    ...
                    var d = s.getLine(t), p = d.search(/\S/), n = s.getLine(t + 1), i = s.getLine(t - 1), a = i.search(/\S/), o = n.search(/\S/);
                    if (-1 == p) return s.foldWidgets[t - 1] = -1 != a && a < o ? "start" : "", "";
                    if (-1 == a) {
                        if (p == o && "#" == d[p] && "#" == n[p]) return s.foldWidgets[t - 1] = "", s.foldWidgets[t + 1] = "", 
                        "start";
                    } else if (a == p && "#" == d[p] && "#" == i[p] && -1 == s.getLine(t - 2).search(/\S/)) return s.foldWidgets[t - 1] = "start", 
                    s.foldWidgets[t + 1] = "", "";
                    return s.foldWidgets[t - 1] = -1 != a && a < p ? "start" : "", p < o ? "start" : "";
                };
            }.call(i.prototype);
        }), ace.define("ace/mode/assembly_x86", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/assembly_x86_highlight_rules", "ace/mode/folding/coffee" ], function(s, e, t) {
            "use strict";
            var d = s("../lib/oop"), p = s("./text").Mode, n = s("./assembly_x86_highlight_rules").AssemblyX86HighlightRules, i = s("./folding/coffee").FoldMode, a = function() {
                this.HighlightRules = n, this.foldingRules = new i(), this.$behaviour = this.$defaultBehaviour;
            };
            d.inherits(a, p), function() {
                this.lineCommentStart = ";", this.$id = "ace/mode/assembly_x86";
            }.call(a.prototype), e.Mode = a;
        });
    }
});
//# sourceMappingURL=assembly_x86.js.map