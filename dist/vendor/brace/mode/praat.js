        ...
        ace.define("ace/mode/praat_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, o = function() {
                this.$rules = {
                    start: [ {
                        ...
                        token: "keyword",
                        regex: "(\\b(?:if|then|else|elsif|elif|endif|fi|endfor|endproc|while|endwhile|repeat|until|select|plus|minus|assert|asserterror)\\b)"
                    }, {
                        token: "string",
                        regex: /"[^"]*"/
                    }, {
            ...
            (function() {
                this.checkOutdent = function(e, t) {
                    ...
                    if (!i) return 0;
                    var o = i[1].length, s = e.findMatchingBracket({
                        row: t,
                        column: o
                    });
            ...
            "use strict";
            var r = e("../../lib/oop"), i = e("../../range").Range, o = e("./fold_mode").FoldMode, s = t.FoldMode = function(e) {
            ...
            r.inherits(s, o), function() {
                ...
                this.getFoldWidget = function(e, t, n) {
                    ...
                    if (o) {
                        ...
                        return a && !a.isMultiLine() && (r ? a = this.getSectionRange(e, n) : "all" != t && (a = null)), 
                        a;
                    }
                    if ("markbegin" !== t) {
                    ...
                    var n = e.getLine(t), r = n.search(/\S/), o = t, s = n.length;
                    t += 1;
                    ...
                    for (var r = t.search(/\s*$/), o = e.getLength(), s = n, a = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, l = 1; ++n < o; ) {
                        t = e.getLine(n);
                        var c = a.exec(t);
                        if (c && (c[1] ? l-- : l++, !l)) break;
                    }
                    var d = n;
                    if (d > s) return new i(s, r, d, t.length);
                };
            }.call(s.prototype);
            ...
            "use strict";
            var r = e("../lib/oop"), i = e("./text").Mode, o = e("./praat_highlight_rules").PraatHighlightRules, s = e("./matching_brace_outdent").MatchingBraceOutdent, a = e("./folding/cstyle").FoldMode, l = function() {
                this.HighlightRules = o, this.$outdent = new s(), this.foldingRules = new a(), this.$behaviour = this.$defaultBehaviour;
            };
