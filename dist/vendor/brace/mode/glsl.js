flklrJsonp([ 143 ], {
    53: function(e, t) {
        ace.define("ace/mode/doc_comment_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function(e, t, n) {
            ...
            r.inherits(l, o), t.c_cppHighlightRules = l;
            ...
            r.inherits(a, o), function() {
                ...
                this.getFoldWidget = function(e, t, n) {
                    ...
                    var g = n;
                    if (g > a) return new i(a, r, g, t.length);
                };
            }.call(a.prototype);
            ...
            "use strict";
            var r = e("../lib/oop"), i = e("./text").Mode, o = e("./c_cpp_highlight_rules").c_cppHighlightRules, a = e("./matching_brace_outdent").MatchingBraceOutdent, l = (e("../range").Range, 
            e("./behaviour/cstyle").CstyleBehaviour), s = e("./folding/cstyle").FoldMode, c = function() {
                this.HighlightRules = o, this.$outdent = new a(), this.$behaviour = new l(), this.foldingRules = new s();
            };
            r.inherits(c, i), function() {
                this.lineCommentStart = "//", this.blockComment = {
                    ...
                    var r = this.$getIndent(t), i = this.getTokenizer().getLineTokens(t, e), o = i.tokens, a = i.state;
            ...
            "use strict";
            var r = e("../lib/oop"), i = e("./c_cpp_highlight_rules").c_cppHighlightRules, o = function() {
            ...
            r.inherits(o, i), t.glslHighlightRules = o;
            ...
            "use strict";
            var r = e("../lib/oop"), i = e("./c_cpp").Mode, o = e("./glsl_highlight_rules").glslHighlightRules, a = e("./matching_brace_outdent").MatchingBraceOutdent, l = (e("../range").Range, 
            e("./behaviour/cstyle").CstyleBehaviour), s = e("./folding/cstyle").FoldMode, c = function() {
                this.HighlightRules = o, this.$outdent = new a(), this.$behaviour = new l(), this.foldingRules = new s();
            };
            r.inherits(c, i), function() {
