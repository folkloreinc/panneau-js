flklrJsonp([ 76 ], {
    140: function(e, t) {
        ace.define("ace/mode/folding/cstyle", [ "require", "exports", "module", "ace/lib/oop", "ace/range", "ace/mode/folding/fold_mode" ], function(e, t, n) {
            ...
            i.inherits(a, o), function() {
                ...
                this.getFoldWidget = function(e, t, n) {
                    ...
                    if (o) {
                        ...
                        var g = e.getCommentFoldRange(n, a + o[0].length, 1);
                    ...
                    return new r(o, a, g, e.getLine(g).length);
                }, this.getCommentRegionBlock = function(e, t, n) {
                    for (var i = t.search(/\s*$/), o = e.getLength(), a = n, g = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, s = 1; ++n < o; ) {
                        t = e.getLine(n);
                        var c = g.exec(t);
            ...
            i.inherits(o, r), t.TclHighlightRules = o;
            ...
            "use strict";
            var i = e("../lib/oop"), r = e("./text").Mode, o = e("./folding/cstyle").FoldMode, a = e("./tcl_highlight_rules").TclHighlightRules, g = e("./matching_brace_outdent").MatchingBraceOutdent, s = (e("../range").Range, 
            function() {
                this.HighlightRules = a, this.$outdent = new g(), this.foldingRules = new o(), this.$behaviour = this.$defaultBehaviour;
            });
