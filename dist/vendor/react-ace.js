flklrJsonp([ 177, 178 ], {
    11: function(e, t, i) {
        !function() {
            ...
            if (Array.prototype.forEach || (Array.prototype.forEach = function(e) {
                var t = D(this), i = p && "[object String]" == d(this) ? this.split("") : t, n = arguments[1], s = -1, o = i.length >>> 0;
                if ("[object Function]" != d(e)) throw new TypeError();
                for (;++s < o; ) s in i && e.call(n, i[s], s, t);
            }), Array.prototype.map || (Array.prototype.map = function(e) {
                var t = D(this), i = p && "[object String]" == d(this) ? this.split("") : t, n = i.length >>> 0, s = Array(n), o = arguments[1];
                if ("[object Function]" != d(e)) throw new TypeError(e + " is not a function");
                for (var r = 0; r < n; r++) r in i && (s[r] = e.call(o, i[r], r, t));
                return s;
            }), Array.prototype.filter || (Array.prototype.filter = function(e) {
                var t, i = D(this), n = p && "[object String]" == d(this) ? this.split("") : i, s = n.length >>> 0, o = [], r = arguments[1];
                if ("[object Function]" != d(e)) throw new TypeError(e + " is not a function");
                for (var a = 0; a < s; a++) a in n && (t = n[a], e.call(r, t, a, i) && o.push(t));
                return o;
            }), Array.prototype.every || (Array.prototype.every = function(e) {
                var t = D(this), i = p && "[object String]" == d(this) ? this.split("") : t, n = i.length >>> 0, s = arguments[1];
                if ("[object Function]" != d(e)) throw new TypeError(e + " is not a function");
                ...
                var t = D(this), i = p && "[object String]" == d(this) ? this.split("") : t, n = i.length >>> 0;
                if ("[object Function]" != d(e)) throw new TypeError(e + " is not a function");
                ...
                var t = p && "[object String]" == d(this) ? this.split("") : D(this), i = t.length >>> 0;
                if (!i) return -1;
                var n = 0;
            ...
            if (Object.defineProperty) {
                var C = doesDefinePropertyWork({}), v = "undefined" == typeof document || doesDefinePropertyWork(document.createElement("div"));
                if (!C || !v) var F = Object.defineProperty;
            }
            ...
            if (!String.prototype.trim || $.trim()) {
                $ = "[" + $ + "]";
                var S = new RegExp("^" + $ + $ + "*"), B = new RegExp($ + $ + "*$");
                String.prototype.trim = function() {
                    return String(this).replace(S, "").replace(B, "");
                };
            }
            var D = function(e) {
            ...
            var n = e("../lib/event"), s = e("../lib/useragent"), o = e("../lib/dom"), r = e("../lib/lang"), a = s.isChrome < 18, l = s.isIE, h = function(e, t) {
                ...
                if (!i.setSelectionRange && i.createTextRange && (i.setSelectionRange = function(e, t) {
                    ...
                    var v = !1, F = function(e) {
                        if (!v) {
                            var t = i.value;
                            if (!d && t && t != h) {
                                if (e && t == h[0]) return w.schedule();
                                S(t), v = !0, resetValue(), v = !1;
                            }
                        }
                    }, w = r.delayedCall(F);
                    n.addListener(i, "propertychange", F);
                    var E = {
                        13: 1,
                        27: 1
                    };
                ...
                var $ = !1, S = function(e) {
                    ...
                    D(e, o) ? (s ? t.onCut() : t.onCopy(), n.preventDefault(e)) : (c = !0, i.value = o, 
                ...
                n.addListener(i, "input", B), n.addListener(i, "cut", x), n.addListener(i, "copy", L), 
                ...
                var M = function(e) {
                    ...
                    if (t.onCompositionEnd && !t.$readOnly) {
                        ...
                        var o = setTimeout(function() {
                            o = null;
                            var e = i.value.replace(/\x01/g, "");
                            d || (e == n.lastValue ? resetValue() : !n.lastValue && e && (resetValue(), S(e)));
                        });
                        y = function(e) {
                ...
                n.addListener(i, "compositionstart", M), s.isGecko ? n.addListener(i, "text", function() {
                    ...
                    if (r || !s.isOldIE) {
                        ...
                        clearTimeout(W), s.isWin && !s.isOldIE && n.capture(t.container, d, onContextMenuClose));
                    }
                }, this.onContextMenuClose = onContextMenuClose;
                var W, I = function(e) {
                    t.textInput.onContextMenu(e), onContextMenuClose();
                };
                n.addListener(i, "mouseup", I), n.addListener(i, "mousedown", function(e) {
                    e.preventDefault(), onContextMenuClose();
                }), n.addListener(t.renderer.scroller, "contextmenu", I), n.addListener(i, "contextmenu", I);
            };
            t.TextInput = h;
            ...
            function DragdropHandler(e) {
                function scrollCursorIntoView(e, i) {
                    ...
                    C = n, v = {
                        ...
                        calcDistance(v.x, v.y, c, u) > l ? C = null : n - C >= a && (t.renderer.scrollCursorIntoView(), 
                        C = null);
                    }
                }
                ...
                var h, c, u, d, g, f, m, p, A, C, v, F = t.container, w = 0;
                this.onDragStart = function(e) {
                    ...
                    if (F.draggable = !1, p = !1, this.setState(null), !t.getReadOnly()) {
                ...
                }, s.addListener(F, "dragstart", this.onDragStart.bind(e)), s.addListener(F, "dragend", this.onDragEnd.bind(e)), 
                s.addListener(F, "dragenter", this.onDragEnter.bind(e)), s.addListener(F, "dragover", this.onDragOver.bind(e)), 
                s.addListener(F, "dragleave", this.onDragLeave.bind(e)), s.addListener(F, "drop", this.onDrop.bind(e));
                var E = null;
            }
            function calcDistance(e, t, i, n) {
                return Math.sqrt(Math.pow(i - e, 2) + Math.pow(n - t, 2));
            ...
            function init(s) {
                if (a && a.document) {
                    ...
                    for (var F in o) void 0 !== o[F] && t.set(F, o[F]);
                }
            }
            ...
            (function() {
                ...
                this.getTokenizer = function() {
                    ...
                    if (this.lineCommentStart) {
                        ...
                        var d = this.blockComment.start, C = this.blockComment.end, u = new RegExp("^(\\s*)(?:" + a.escapeRegExp(d) + ")"), v = new RegExp("(?:" + a.escapeRegExp(C) + ")\\s*$"), m = function(e, t) {
                            ...
                            var i;
                            (i = e.match(v)) && s.removeInLine(t, e.length - i[0].length, e.length), (i = e.match(u)) && s.removeInLine(t, i[1].length, i[0].length);
                        }, p = function(e, i) {
                    ...
                    iter(function(e, t) {
                        var i = e.search(/\S/);
                        -1 !== i ? (i < l && (l = i), r && !p(e, t) && (r = !1)) : F > e.length && (F = e.length);
                    }), l == 1 / 0 && (l = F, o = !1, r = !1), c && l % h != 0 && (l = Math.floor(l / h) * h), 
                    iter(r ? g : m);
            ...
            (function() {
                this.set = function(e) {
                    ...
                    if (i) {
                        for (var F = i.start.column, w = i.start.column, A = 0, d = r.length - 1; A < d && r[A].start.column < F && r[A].start.row == i.start.row; ) A++;
            ...
            }).call(v.prototype), A.defineOptions(v.prototype, "editor", {
                selectionStyle: {
                    set: function(e) {
            ...
            (function() {
                s.implement(this, r), this.setSession = function(e) {
                    ...
                    var F = d ? d.getWidth(t, u, e) : u.toString().length * e.characterWidth, w = this.$padding || this.$computePadding();
                    (F += w.left + w.right) === this.gutterWidth || isNaN(F) || (this.gutterWidth = F, 
            ...
            (function() {
                ...
                n.implement(this, m), this.updateCharacterSize = function() {
                    ...
                    var m, p, A = Math.ceil(c / this.lineHeight) - 1, C = Math.max(0, Math.round((this.scrollTop - h) / this.lineHeight)), v = C + A, F = this.lineHeight;
                    C = e.screenToDocumentRow(C, 0);
                    var w = e.getFoldLine(C);
                    w && (C = w.start.row), m = e.documentToScreenRow(C, 0), p = e.getRowLength(C) * F, 
                    v = Math.min(e.screenToDocumentRow(v, 0), e.getLength() - 1), c = t.scrollerHeight + e.getRowLength(v) * F + p, 
                    ...
                    this.layerConfig = {
                        ...
                        maxHeight: s,
                        offset: h,
                        gutterOffset: F ? Math.max(0, Math.ceil((h + t.height - t.scrollerHeight) / F)) : 0,
            ...
            function onMouseDown(e) {
                ...
                if (0 === l) {
                    ...
                    }, v = c.session, F = c.renderer.pixelToScreenCoordinates(p, A), w = F;
                    ...
                    if (h && s.isMac && t.ctrlKey && c.$mouseHandler.cancelContextMenu(), "add" == h) {
                        ...
                        var y, $ = [], S = function() {
                            var e = c.renderer.pixelToScreenCoordinates(p, A), t = v.screenToDocumentPosition(e.row, e.column);
                            isSamePoint(w, e) && isSamePoint(t, u.lead) || (w = e, c.$blockScrolling++, c.selection.moveToPosition(t), 
                            c.renderer.scrollCursorIntoView(), c.removeSelectionMarkers($), $ = u.rectangularRangeBlock(w, F), 
                        ...
                        c.addSelectionMarker(y)), o ? F = v.documentToScreenPosition(u.lead) : u.moveToPosition(g), 
                        c.$blockScrolling--, w = {
                            row: -1,
                            column: -1
                        };
    ...
    210: function(e, t, i) {
        ...
        var n = [ "minLines", "maxLines", "readOnly", "highlightActiveLine", "tabSize", "enableBasicAutocompletion", "enableLiveAutocompletion", "enableSnippets" ], s = [ "onChange", "onFocus", "onBlur", "onCopy", "onPaste", "onSelectionChange", "onScroll", "handleOptions", "updateRef" ];
        t.editorOptions = n, t.editorEvents = s;
    },
    213: function(e, t, i) {
        "use strict";
        ...
        }(), o = i(11), r = _interopRequireDefault(o), a = i(0), l = _interopRequireDefault(a), h = i(1), c = _interopRequireDefault(h), u = i(202), d = _interopRequireDefault(u), g = i(210), f = r.default.acequire("ace/range"), m = f.Range, p = function(e) {
            function ReactAce(e) {
                _classCallCheck(this, ReactAce);
                var t = _possibleConstructorReturn(this, (ReactAce.__proto__ || Object.getPrototypeOf(ReactAce)).call(this, e));
                return g.editorEvents.forEach(function(e) {
                    t[e] = t[e].bind(t);
                }), t;
            }
            return _inherits(ReactAce, e), s(ReactAce, [ {
                key: "componentDidMount",
                value: function() {
                    var e = this, t = this.props, i = t.className, n = t.onBeforeLoad, s = t.onValidate, o = t.mode, a = t.focus, l = t.theme, h = t.fontSize, c = t.value, u = t.defaultValue, d = t.cursorStart, f = t.showGutter, m = t.wrapEnabled, p = t.showPrintMargin, A = t.scrollMargin, C = void 0 === A ? [ 0, 0, 0, 0 ] : A, v = t.keyboardHandler, F = t.onLoad, w = t.commands, E = t.annotations, b = t.markers;
                    this.editor = r.default.edit(this.refEditor), n && n(r.default);
                    for (var y = Object.keys(this.props.editorProps), $ = 0; $ < y.length; $++) this.editor[y[$]] = this.props.editorProps[y[$]];
                    this.editor.renderer.setScrollMargin(C[0], C[1], C[2], C[3]), this.editor.getSession().setMode("ace/mode/" + o), 
                    this.editor.setTheme("ace/theme/" + l), this.editor.setFontSize(h), this.editor.setValue(void 0 === u ? c : u, d), 
                    this.editor.renderer.setShowGutter(f), this.editor.getSession().setUseWrapMode(m), 
                    this.editor.setShowPrintMargin(p), this.editor.on("focus", this.onFocus), this.editor.on("blur", this.onBlur), 
                    this.editor.on("copy", this.onCopy), this.editor.on("paste", this.onPaste), this.editor.on("change", this.onChange), 
                    this.editor.getSession().selection.on("changeSelection", this.onSelectionChange), 
                    s && this.editor.getSession().on("changeAnnotation", function() {
                        var t = e.editor.getSession().getAnnotations();
                        e.props.onValidate(t);
                    }), this.editor.session.on("changeScrollTop", this.onScroll), this.editor.getSession().setAnnotations(E || []), 
                    b && b.length > 0 && this.handleMarkers(b);
                    for (var S = this.editor.$options, B = 0; B < g.editorOptions.length; B++) {
                        var D = g.editorOptions[B];
                        S.hasOwnProperty(D) ? this.editor.setOption(D, this.props[D]) : this.props[D] && console.warn("ReaceAce: editor option " + D + " was activated but not found. Did you need to import a related tool or did you possibly mispell the option?");
                    }
                    this.handleOptions(this.props), Array.isArray(w) && w.forEach(function(t) {
                        e.editor.commands.addCommand(t);
                    }), v && this.editor.setKeyboardHandler("ace/keyboard/" + v), i && (this.refEditor.className += " " + i), 
                    a && this.editor.focus(), F && F(this.editor), this.editor.resize();
                }
            }, {
                key: "componentWillReceiveProps",
                value: function(e) {
                    for (var t = this.props, i = 0; i < g.editorOptions.length; i++) {
                        var n = g.editorOptions[i];
                        e[n] !== t[n] && this.editor.setOption(n, e[n]);
                    }
                    if (e.className !== t.className) {
                        var s = this.refEditor.className, o = s.trim().split(" ");
                        t.className.trim().split(" ").forEach(function(e) {
                            var t = o.indexOf(e);
                            o.splice(t, 1);
                        }), this.refEditor.className = " " + e.className + " " + o.join(" ");
                    }
                    if (e.mode !== t.mode && this.editor.getSession().setMode("ace/mode/" + e.mode), 
                    e.theme !== t.theme && this.editor.setTheme("ace/theme/" + e.theme), e.keyboardHandler !== t.keyboardHandler && (e.keyboardHandler ? this.editor.setKeyboardHandler("ace/keyboard/" + e.keyboardHandler) : this.editor.setKeyboardHandler(null)), 
                    e.fontSize !== t.fontSize && this.editor.setFontSize(e.fontSize), e.wrapEnabled !== t.wrapEnabled && this.editor.getSession().setUseWrapMode(e.wrapEnabled), 
                    e.showPrintMargin !== t.showPrintMargin && this.editor.setShowPrintMargin(e.showPrintMargin), 
                    e.showGutter !== t.showGutter && this.editor.renderer.setShowGutter(e.showGutter), 
                    (0, d.default)(e.setOptions, t.setOptions) || this.handleOptions(e), (0, d.default)(e.annotations, t.annotations) || this.editor.getSession().setAnnotations(e.annotations || []), 
                    !(0, d.default)(e.markers, t.markers) && Array.isArray(e.markers) && this.handleMarkers(e.markers), 
                    (0, d.default)(e.scrollMargin, t.scrollMargin) || this.handleScrollMargins(e.scrollMargin), 
                    this.editor && this.editor.getValue() !== e.value) {
                        this.silent = !0;
                        var r = this.editor.session.selection.toJSON();
                        this.editor.setValue(e.value, e.cursorStart), this.editor.session.selection.fromJSON(r), 
                        this.silent = !1;
                    }
                    e.focus && !t.focus && this.editor.focus();
                }
            }, {
                ...
                value: function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [ 0, 0, 0, 0 ];
                    this.editor.renderer.setScrollMargins(e[0], e[1], e[2], e[3]);
                }
            }, {
                ...
                key: "handleOptions",
                value: function(e) {
                    for (var t = Object.keys(e.setOptions), i = 0; i < t.length; i++) this.editor.setOption(t[i], e.setOptions[t[i]]);
                }
            }, {
                key: "handleMarkers",
                value: function(e) {
                    var t = this, i = this.editor.getSession().getMarkers(!0);
                    for (var n in i) i.hasOwnProperty(n) && this.editor.getSession().removeMarker(i[n].id);
                    i = this.editor.getSession().getMarkers(!1);
                    for (var s in i) i.hasOwnProperty(s) && this.editor.getSession().removeMarker(i[s].id);
                    e.forEach(function(e) {
                        var i = e.startRow, n = e.startCol, s = e.endRow, o = e.endCol, r = e.className, a = e.type, l = e.inFront, h = void 0 !== l && l, c = new m(i, n, s, o);
                        t.editor.getSession().addMarker(c, r, a, h);
                    });
                }
            }, {
                key: "updateRef",
                ...
                key: "render",
                value: function() {
                    var e = this.props, t = e.name, i = e.width, s = e.height, o = e.style, r = n({
                        width: i,
                        height: s
                    }, o);
        ...
        t.default = p, p.propTypes = {
            ...
            onSelectionChange: c.default.func,
            onBeforeLoad: c.default.func,
            onValidate: c.default.func,
            minLines: c.default.number,
            maxLines: c.default.number,
            readOnly: c.default.bool,
            highlightActiveLine: c.default.bool,
            tabSize: c.default.number,
            showPrintMargin: c.default.bool,
            cursorStart: c.default.number,
            editorProps: c.default.object,
            setOptions: c.default.object,
            style: c.default.object,
            scrollMargin: c.default.array,
            annotations: c.default.array,
            markers: c.default.array,
            keyboardHandler: c.default.string,
            wrapEnabled: c.default.bool,
            enableBasicAutocompletion: c.default.oneOfType([ c.default.bool, c.default.array ]),
            enableLiveAutocompletion: c.default.oneOfType([ c.default.bool, c.default.array ]),
            commands: c.default.array
        }, p.defaultProps = {
            name: "brace-editor",
            focus: !1,
            mode: "",
    ...
    214: function(e, t, i) {
        ...
        }(), o = i(11), r = _interopRequireDefault(o), a = i(0), l = _interopRequireDefault(a), h = i(1), c = _interopRequireDefault(h), u = i(202), d = _interopRequireDefault(u), g = i(203), f = _interopRequireDefault(g), m = i(210);
        i(215);
        var p = r.default.acequire("ace/range"), A = p.Range, C = r.default.acequire("ace/split"), v = C.Split, F = function(e) {
            function SplitComponent(e) {
                _classCallCheck(this, SplitComponent);
                var t = _possibleConstructorReturn(this, (SplitComponent.__proto__ || Object.getPrototypeOf(SplitComponent)).call(this, e));
                return m.editorEvents.forEach(function(e) {
                    t[e] = t[e].bind(t);
                }), t;
            }
            return _inherits(SplitComponent, e), s(SplitComponent, [ {
                key: "componentDidMount",
                value: function() {
                    var e = this, t = this.props, i = t.className, n = t.onBeforeLoad, s = t.mode, o = t.focus, a = t.theme, l = t.fontSize, h = t.value, c = t.defaultValue, u = t.cursorStart, d = t.showGutter, g = t.wrapEnabled, p = t.showPrintMargin, A = t.scrollMargin, C = void 0 === A ? [ 0, 0, 0, 0 ] : A, F = t.keyboardHandler, w = t.onLoad, E = t.commands, b = t.annotations, y = t.markers, $ = t.splits;
                    this.editor = r.default.edit(this.refEditor), n && n(r.default);
                    var S = Object.keys(this.props.editorProps), B = new v(this.editor.container, "ace/theme/" + a, $);
                    this.editor.env.split = B, this.splitEditor = B.getEditor(0), this.split = B, this.editor.setShowPrintMargin(!1), 
                    this.editor.renderer.setShowGutter(!1);
                    var D = this.splitEditor.$options;
                    B.forEach(function(t, i) {
                        for (var n = 0; n < S.length; n++) t[S[n]] = e.props.editorProps[S[n]];
                        var o = (0, f.default)(c, i), r = (0, f.default)(h, i, "");
                        t.setTheme("ace/theme/" + a), t.renderer.setScrollMargin(C[0], C[1], C[2], C[3]), 
                        t.getSession().setMode("ace/mode/" + s), t.setFontSize(l), t.renderer.setShowGutter(d), 
                        t.getSession().setUseWrapMode(g), t.setShowPrintMargin(p), t.on("focus", e.onFocus), 
                        t.on("blur", e.onBlur), t.on("copy", e.onCopy), t.on("paste", e.onPaste), t.on("change", e.onChange), 
                        t.getSession().selection.on("changeSelection", e.onSelectionChange), t.session.on("changeScrollTop", e.onScroll), 
                        t.setValue(void 0 === o ? r : o, u);
                        var A = (0, f.default)(b, i, []), v = (0, f.default)(y, i, []);
                        t.getSession().setAnnotations(A), v && v.length > 0 && e.handleMarkers(v, t);
                        for (var w = 0; w < m.editorOptions.length; w++) {
                            var $ = m.editorOptions[w];
                            D.hasOwnProperty($) ? t.setOption($, e.props[$]) : e.props[$] && console.warn("ReaceAce: editor option " + $ + " was activated but not found. Did you need to import a related tool or did you possibly mispell the option?");
                        }
                        e.handleOptions(e.props, t), Array.isArray(E) && E.forEach(function(e) {
                            t.commands.addCommand(e);
                        }), F && t.setKeyboardHandler("ace/keyboard/" + F);
                    }), i && (this.refEditor.className += " " + i), o && this.splitEditor.focus();
                    var k = this.editor.env.split;
                    k.setOrientation("below" === this.props.orientation ? k.BELOW : k.BESIDE), k.resize(!0), 
                    w && w(k);
                }
            }, {
                key: "componentWillReceiveProps",
                value: function(e) {
                    var t = this, i = this.props, n = this.editor.env.split;
                    if (e.splits !== i.splits && n.setSplits(e.splits), e.orientation !== i.orientation && n.setOrientation("below" === e.orientation ? n.BELOW : n.BESIDE), 
                    n.forEach(function(n, s) {
                        e.mode !== i.mode && n.getSession().setMode("ace/mode/" + e.mode), e.keyboardHandler !== i.keyboardHandler && (e.keyboardHandler ? n.setKeyboardHandler("ace/keyboard/" + e.keyboardHandler) : n.setKeyboardHandler(null)), 
                        e.fontSize !== i.fontSize && n.setFontSize(e.fontSize), e.wrapEnabled !== i.wrapEnabled && n.getSession().setUseWrapMode(e.wrapEnabled), 
                        e.showPrintMargin !== i.showPrintMargin && n.setShowPrintMargin(e.showPrintMargin), 
                        e.showGutter !== i.showGutter && n.renderer.setShowGutter(e.showGutter);
                        for (var o = 0; o < m.editorOptions.length; o++) {
                            var r = m.editorOptions[o];
                            e[r] !== i[r] && n.setOption(r, e[r]);
                        }
                        (0, d.default)(e.setOptions, i.setOptions) || t.handleOptions(e, n);
                        var a = (0, f.default)(e.value, s, "");
                        if (n.getValue() !== a) {
                            t.silent = !0;
                            var l = n.session.selection.toJSON();
                            n.setValue(a, e.cursorStart), n.session.selection.fromJSON(l), t.silent = !1;
                        }
                        var h = (0, f.default)(e.annotations, s, []), c = (0, f.default)(i.annotations, s, []);
                        (0, d.default)(h, c) || n.getSession().setAnnotations(h);
                        var u = (0, f.default)(e.markers, s, []), g = (0, f.default)(i.markers, s, []);
                        !(0, d.default)(u, g) && Array.isArray(u) && t.handleMarkers(u, n);
                    }), e.className !== i.className) {
                        var s = this.refEditor.className, o = s.trim().split(" ");
                        i.className.trim().split(" ").forEach(function(e) {
                            var t = o.indexOf(e);
                            o.splice(t, 1);
                        }), this.refEditor.className = " " + e.className + " " + o.join(" ");
                    }
                    e.theme !== i.theme && n.setTheme("ace/theme/" + e.theme), e.focus && !i.focus && this.splitEditor.focus(), 
                    e.height === this.props.height && e.width === this.props.width || this.editor.resize();
                }
            }, {
                key: "componentWillUnmount",
                ...
                key: "handleOptions",
                value: function(e, t) {
                    for (var i = Object.keys(e.setOptions), n = 0; n < i.length; n++) t.setOption(i[n], e.setOptions[i[n]]);
                }
            }, {
                key: "handleMarkers",
                value: function(e, t) {
                    ...
                    i = t.getSession().getMarkers(!1);
                    for (var s in i) i.hasOwnProperty(s) && t.getSession().removeMarker(i[s].id);
                    e.forEach(function(e) {
                        var i = e.startRow, n = e.startCol, s = e.endRow, o = e.endCol, r = e.className, a = e.type, l = e.inFront, h = void 0 !== l && l, c = new A(i, n, s, o);
                        t.getSession().addMarker(c, r, a, h);
                    });
                }
            }, {
                key: "updateRef",
        ...
        t.default = F, F.propTypes = {
            mode: c.default.string,
            splits: c.default.number,
            orientation: c.default.string,
            focus: c.default.bool,
            theme: c.default.string,
            name: c.default.string,
            className: c.default.string,
            ...
            onBlur: c.default.func,
            onScroll: c.default.func,
            value: c.default.arrayOf(c.default.string),
            defaultValue: c.default.arrayOf(c.default.string),
            onLoad: c.default.func,
            onSelectionChange: c.default.func,
            onBeforeLoad: c.default.func,
            minLines: c.default.number,
    ...
    215: function(e, t) {
        ace.define("ace/split", [ "require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/lib/event_emitter", "ace/editor", "ace/virtual_renderer", "ace/edit_session" ], function(e, t, i) {
            "use strict";
            function UndoManagerProxy(e, t) {
                this.$u = e, this.$doc = t;
            }
            var n = e("./lib/oop"), s = e("./lib/lang"), o = e("./lib/event_emitter").EventEmitter, r = e("./editor").Editor, a = e("./virtual_renderer").VirtualRenderer, l = e("./edit_session").EditSession, h = function(e, t, i) {
                this.BELOW = 1, this.BESIDE = 0, this.$container = e, this.$theme = t, this.$splits = 0, 
                this.$editorCSS = "", this.$editors = [], this.$orientation = this.BESIDE, this.setSplits(i || 1), 
                this.$cEditor = this.$editors[0], this.on("focus", function(e) {
                    this.$cEditor = e;
                }.bind(this));
            };
            (function() {
                n.implement(this, o), this.$createEditor = function() {
                    var e = document.createElement("div");
                    e.className = this.$editorCSS, e.style.cssText = "position: absolute; top:0px; bottom:0px", 
                    this.$container.appendChild(e);
                    var t = new r(new a(e, this.$theme));
                    ...
                    if (e != this.$splits) {
                        if (e > this.$splits) {
                            for (;this.$splits < this.$editors.length && this.$splits < e; ) t = this.$editors[this.$splits], 
                            this.$container.appendChild(t.container), t.setFontSize(this.$fontSize), this.$splits++;
                            for (;this.$splits < e; ) this.$createEditor(), this.$splits++;
                        } else for (;this.$splits > e; ) t = this.$editors[this.$splits - 1], this.$container.removeChild(t.container), 
                        this.$splits--;
                        this.resize();
                    }
                    ...
                    var t = new l(e.getDocument(), e.getMode()), i = e.getUndoManager();
                    if (i) {
                        var n = new UndoManagerProxy(i, t);
                        t.setUndoManager(n);
                    }
                    return t.$informUndoManager = s.delayedCall(function() {
                        t.$deltas = [];
                    }), t.setTabSize(e.getTabSize()), t.setUseSoftTabs(e.getUseSoftTabs()), t.setOverwrite(e.getOverwrite()), 
                    t.setBreakpoints(e.getBreakpoints()), t.setUseWrapMode(e.getUseWrapMode()), t.setUseWorker(e.getUseWorker()), 
                    t.setWrapLimitRange(e.$wrapLimitRange.min, e.$wrapLimitRange.max), t.$foldData = e.$cloneFoldData(), 
                    t;
                }, this.setSession = function(e, t) {
                    var i;
                    return i = null == t ? this.$cEditor : this.$editors[t], this.$editors.some(function(t) {
                        return t.session === e;
                    }) && (e = this.$cloneSession(e)), i.setSession(e), e;
                }, this.getOrientation = function() {
                    return this.$orientation;
                }, this.setOrientation = function(e) {
                    this.$orientation != e && (this.$orientation = e, this.resize());
                }, this.resize = function() {
                    var e, t = this.$container.clientWidth, i = this.$container.clientHeight;
                    if (this.$orientation == this.BESIDE) for (var n = t / this.$splits, s = 0; s < this.$splits; s++) e = this.$editors[s], 
                    e.container.style.width = n + "px", e.container.style.top = "0px", e.container.style.left = s * n + "px", 
                    e.container.style.height = i + "px", e.resize(); else for (var o = i / this.$splits, s = 0; s < this.$splits; s++) e = this.$editors[s], 
                    e.container.style.width = t + "px", e.container.style.top = s * o + "px", e.container.style.left = "0px", 
                    e.container.style.height = o + "px", e.resize();
                };
            ...
            }.call(UndoManagerProxy.prototype), t.Split = h;
    ...
    217: function(e, t, i) {
        ...
        var n = i(213), s = _interopRequireDefault(n), o = i(214), r = _interopRequireDefault(o);
        t.split = r.default, t.default = s.default;
    }
});
